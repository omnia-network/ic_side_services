...
pub struct GetFluxNodeStatus200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Fluxnodestatus>>,
}

impl GetFluxNodeStatus200Response {
    pub fn new() -> GetFluxNodeStatus200Response {
        GetFluxNodeStatus200Response {
            status: None,
            data: None,
        }
    }
