...
pub struct GetAddressTransactions200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetAddressTransactions200ResponseData>>,
}

impl GetAddressTransactions200Response {
    pub fn new() -> GetAddressTransactions200Response {
