...
pub struct GetAppsPermanentMessages200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetAppsPermanentMessages200ResponseDataInner>>,
}

impl GetAppsPermanentMessages200Response {
    pub fn new() -> GetAppsPermanentMessages200Response {
        GetAppsPermanentMessages200Response {
            status: None,
            data: None,
        }
    }
