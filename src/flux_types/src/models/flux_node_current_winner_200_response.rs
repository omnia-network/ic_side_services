...
pub struct FluxNodeCurrentWinner200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxNodeCurrentWinner200ResponseData>>,
}

impl FluxNodeCurrentWinner200Response {
    pub fn new() -> FluxNodeCurrentWinner200Response {
        FluxNodeCurrentWinner200Response {
            status: None,
            data: None,
        }
    }
