...
pub struct GetRawTransaction200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetRawTransaction200ResponseData>>,
}

impl GetRawTransaction200Response {
    pub fn new() -> GetRawTransaction200Response {
        GetRawTransaction200Response {
            status: None,
            data: None,
        }
    }
