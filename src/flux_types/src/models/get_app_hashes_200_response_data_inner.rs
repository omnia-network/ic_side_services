...
pub struct GetAppHashes200ResponseDataInner {
    /// Transaction ID of app payment
    #[serde(rename = "txid", skip_serializing_if = "Option::is_none")]
    pub txid: Option<String>,
    /// Block height of transaction
    #[serde(rename = "height", skip_serializing_if = "Option::is_none")]
    pub height: Option<i32>,
    /// Hash of app registration
    #[serde(rename = "hash", skip_serializing_if = "Option::is_none")]
    pub hash: Option<String>,
    /// Payment of Flux value in sats
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<i32>,
    /// If message is stored or not.
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<bool>,
}

impl GetAppHashes200ResponseDataInner {
    pub fn new() -> GetAppHashes200ResponseDataInner {
        GetAppHashes200ResponseDataInner {
            txid: None,
            height: None,
            hash: None,
            value: None,
