...
pub struct GetMempoolInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetMempoolInfo200ResponseData>>,
}

impl GetMempoolInfo200Response {
    pub fn new() -> GetMempoolInfo200Response {
        GetMempoolInfo200Response {
            status: None,
            data: None,
        }
    }
