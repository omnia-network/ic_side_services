...
pub struct FileExists200ResponseData {
    /// Explanation of file status
    #[serde(rename = "fileexists", skip_serializing_if = "Option::is_none")]
    pub fileexists: Option<bool>,
}

impl FileExists200ResponseData {
    pub fn new() -> FileExists200ResponseData {
        FileExists200ResponseData {
            fileexists: None,
        }
    }
}
