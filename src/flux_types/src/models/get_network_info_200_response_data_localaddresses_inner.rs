...
pub struct GetNetworkInfo200ResponseDataLocaladdressesInner {
    /// Network addess
...
impl GetNetworkInfo200ResponseDataLocaladdressesInner {
    pub fn new() -> GetNetworkInfo200ResponseDataLocaladdressesInner {
        GetNetworkInfo200ResponseDataLocaladdressesInner {
            address: None,
            port: None,
            score: None,
        }
