...
pub struct LoggedSessions200ResponseDataInner {
    /// associated ZelID
    #[serde(rename = "zelid", skip_serializing_if = "Option::is_none")]
    pub zelid: Option<String>,
    /// login phrase used for session
    #[serde(rename = "loginPhrase", skip_serializing_if = "Option::is_none")]
    pub login_phrase: Option<String>,
}

impl LoggedSessions200ResponseDataInner {
    pub fn new() -> LoggedSessions200ResponseDataInner {
        LoggedSessions200ResponseDataInner {
            zelid: None,
            login_phrase: None,
        }
    }
