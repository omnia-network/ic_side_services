...
pub struct AppInspect200ResponseDataHostConfigPortBindings {
    #[serde(rename = "7396/tcp", skip_serializing_if = "Option::is_none")]
    pub param_7396_slash_tcp: Option<Vec<crate::models::AppInspect200ResponseDataHostConfigPortBindings7396TcpInner>>,
}

impl AppInspect200ResponseDataHostConfigPortBindings {
    pub fn new() -> AppInspect200ResponseDataHostConfigPortBindings {
        AppInspect200ResponseDataHostConfigPortBindings {
            param_7396_slash_tcp: None,
        }
    }
}
