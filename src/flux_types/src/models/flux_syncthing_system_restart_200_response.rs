...
pub struct FluxSyncthingSystemRestart200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxSyncthingSystemRestart200ResponseData>>,
}

impl FluxSyncthingSystemRestart200Response {
    pub fn new() -> FluxSyncthingSystemRestart200Response {
        FluxSyncthingSystemRestart200Response {
            status: None,
            data: None,
        }
    }
