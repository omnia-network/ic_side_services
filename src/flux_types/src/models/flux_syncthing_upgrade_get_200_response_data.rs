...
pub struct FluxSyncthingUpgradeGet200ResponseData {
    #[serde(rename = "latest", skip_serializing_if = "Option::is_none")]
    pub latest: Option<String>,
    #[serde(rename = "majorNewer", skip_serializing_if = "Option::is_none")]
    pub major_newer: Option<bool>,
    #[serde(rename = "newer", skip_serializing_if = "Option::is_none")]
    pub newer: Option<bool>,
    #[serde(rename = "running", skip_serializing_if = "Option::is_none")]
    pub running: Option<String>,
}

impl FluxSyncthingUpgradeGet200ResponseData {
    pub fn new() -> FluxSyncthingUpgradeGet200ResponseData {
        FluxSyncthingUpgradeGet200ResponseData {
            latest: None,
            major_newer: None,
            newer: None,
            running: None,
