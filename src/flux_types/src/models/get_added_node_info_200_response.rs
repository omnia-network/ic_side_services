...
pub struct GetAddedNodeInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetAddedNodeInfo200ResponseDataInner>>,
}

impl GetAddedNodeInfo200Response {
    pub fn new() -> GetAddedNodeInfo200Response {
        GetAddedNodeInfo200Response {
            status: None,
            data: None,
        }
    }
