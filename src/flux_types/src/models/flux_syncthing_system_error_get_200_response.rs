...
pub struct FluxSyncthingSystemErrorGet200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxSyncthingSystemErrorGet200ResponseData>>,
}

impl FluxSyncthingSystemErrorGet200Response {
    pub fn new() -> FluxSyncthingSystemErrorGet200Response {
        FluxSyncthingSystemErrorGet200Response {
            status: None,
            data: None,
        }
    }
