...
/// AppInspect200ResponseDataGraphDriver : Information about a container's graph driver



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppInspect200ResponseDataGraphDriver {
    #[serde(rename = "Data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::AppInspect200ResponseDataGraphDriverData>>,
    #[serde(rename = "Name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
}

impl AppInspect200ResponseDataGraphDriver {
    /// Information about a container's graph driver
    pub fn new() -> AppInspect200ResponseDataGraphDriver {
        AppInspect200ResponseDataGraphDriver {
            data: None,
            name: None,
        }
    }
