...
pub struct GetDeprecationInfo200ResponseData {
    /// The server version
    ...
    /// The block height at which this version will deprecate and shut down
    #[serde(rename = "deprecationheight", skip_serializing_if = "Option::is_none")]
    pub deprecationheight: Option<i32>,
}

impl GetDeprecationInfo200ResponseData {
    pub fn new() -> GetDeprecationInfo200ResponseData {
        GetDeprecationInfo200ResponseData {
            version: None,
            subversion: None,
            deprecationheight: None,
        }
    }
}
