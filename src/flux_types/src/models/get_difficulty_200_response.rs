...
pub struct GetDifficulty200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Proof of work difficulty as a multiple
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<f32>,
}

impl GetDifficulty200Response {
    pub fn new() -> GetDifficulty200Response {
        GetDifficulty200Response {
            status: None,
            data: None,
        }
    }
