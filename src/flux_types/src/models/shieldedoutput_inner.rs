...
pub struct ShieldedoutputInner {
    /// Output cv note
    #[serde(rename = "cv", skip_serializing_if = "Option::is_none")]
    pub cv: Option<String>,
    /// Output cmu note
    #[serde(rename = "cmu", skip_serializing_if = "Option::is_none")]
    pub cmu: Option<String>,
    /// The ephemeral key
    #[serde(rename = "ephemeralKey", skip_serializing_if = "Option::is_none")]
    pub ephemeral_key: Option<String>,
    /// The encrypted ciphertext
    #[serde(rename = "encCiphertext", skip_serializing_if = "Option::is_none")]
    pub enc_ciphertext: Option<String>,
    /// Output note ciphertext
    #[serde(rename = "outCiphertext", skip_serializing_if = "Option::is_none")]
...
impl ShieldedoutputInner {
    pub fn new() -> ShieldedoutputInner {
        ShieldedoutputInner {
            cv: None,
            cmu: None,
            ephemeral_key: None,
