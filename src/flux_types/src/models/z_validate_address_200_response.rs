...
pub struct ZValidateAddress200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ZValidateAddress200ResponseData>>,
}

impl ZValidateAddress200Response {
    pub fn new() -> ZValidateAddress200Response {
        ZValidateAddress200Response {
            status: None,
            data: None,
        }
    }
