...
pub struct FluxSyncthingHealth200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxSyncthingHealth200ResponseData>>,
}

impl FluxSyncthingHealth200Response {
    pub fn new() -> FluxSyncthingHealth200Response {
        FluxSyncthingHealth200Response {
            status: None,
            data: None,
        }
    }
