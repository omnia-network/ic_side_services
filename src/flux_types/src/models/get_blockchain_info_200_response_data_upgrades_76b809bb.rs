...
pub struct GetBlockchainInfo200ResponseDataUpgrades76b809bb {
    /// Name of upgrade
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Activation block height
    #[serde(rename = "activationheight", skip_serializing_if = "Option::is_none")]
    pub activationheight: Option<i32>,
    /// Status of upgrade
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
    /// Additional info of upgrade
    #[serde(rename = "info", skip_serializing_if = "Option::is_none")]
    pub info: Option<String>,
}

impl GetBlockchainInfo200ResponseDataUpgrades76b809bb {
    pub fn new() -> GetBlockchainInfo200ResponseDataUpgrades76b809bb {
        GetBlockchainInfo200ResponseDataUpgrades76b809bb {
            name: None,
