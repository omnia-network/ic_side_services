...
pub struct SharedFiles200ResponseDataInner {
    /// File name
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Token for share file
    #[serde(rename = "token", skip_serializing_if = "Option::is_none")]
    pub token: Option<String>,
}

impl SharedFiles200ResponseDataInner {
    pub fn new() -> SharedFiles200ResponseDataInner {
        SharedFiles200ResponseDataInner {
            name: None,
            token: None,
        }
    }
