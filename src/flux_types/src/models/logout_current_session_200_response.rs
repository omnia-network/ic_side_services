...
pub struct LogoutCurrentSession200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Statusmessage>>,
}

impl LogoutCurrentSession200Response {
    pub fn new() -> LogoutCurrentSession200Response {
        LogoutCurrentSession200Response {
            status: None,
            data: None,
        }
    }
