...
pub struct GetNetworkInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetNetworkInfo200ResponseData>>,
}

impl GetNetworkInfo200Response {
    pub fn new() -> GetNetworkInfo200Response {
        GetNetworkInfo200Response {
            status: None,
            data: None,
        }
    }
