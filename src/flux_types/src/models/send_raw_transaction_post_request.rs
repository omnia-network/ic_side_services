...
pub struct SendRawTransactionPostRequest {
    /// Hex-encoded transaction
    #[serde(rename = "hexstring", skip_serializing_if = "Option::is_none")]
    pub hexstring: Option<String>,
    /// Allow high fees (optional)
    #[serde(rename = "allowhighfees", skip_serializing_if = "Option::is_none")]
    pub allowhighfees: Option<bool>,
}

impl SendRawTransactionPostRequest {
    pub fn new() -> SendRawTransactionPostRequest {
        SendRawTransactionPostRequest {
            hexstring: None,
            allowhighfees: None,
        }
    }
