...
pub struct AppsResources200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Appsresources>>,
}

impl AppsResources200Response {
    pub fn new() -> AppsResources200Response {
        AppsResources200Response {
            status: None,
            data: None,
        }
    }
