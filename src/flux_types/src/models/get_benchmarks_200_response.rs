...
pub struct GetBenchmarks200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Getbenchmarks>>,
}

impl GetBenchmarks200Response {
    pub fn new() -> GetBenchmarks200Response {
        GetBenchmarks200Response {
            status: None,
            data: None,
        }
    }
