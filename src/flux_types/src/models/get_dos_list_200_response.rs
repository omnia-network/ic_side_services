...
pub struct GetDosList200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetDosList200ResponseDataInner>>,
}

impl GetDosList200Response {
    pub fn new() -> GetDosList200Response {
        GetDosList200Response {
            status: None,
            data: None,
        }
    }
