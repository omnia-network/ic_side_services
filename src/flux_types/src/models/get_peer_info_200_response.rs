...
pub struct GetPeerInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetPeerInfo200ResponseDataInner>>,
}

impl GetPeerInfo200Response {
    pub fn new() -> GetPeerInfo200Response {
        GetPeerInfo200Response {
            status: None,
            data: None,
        }
    }
