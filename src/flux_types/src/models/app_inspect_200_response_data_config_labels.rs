...
/// AppInspect200ResponseDataConfigLabels : User-defined key/value metadata



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppInspect200ResponseDataConfigLabels {
...
impl AppInspect200ResponseDataConfigLabels {
    /// User-defined key/value metadata
    pub fn new() -> AppInspect200ResponseDataConfigLabels {
        AppInspect200ResponseDataConfigLabels {
            description: None,
            maintainer: None,
            repository: None,
            version: None,
