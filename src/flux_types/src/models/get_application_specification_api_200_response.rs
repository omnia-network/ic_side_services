...
pub struct GetApplicationSpecificationApi200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::Appname>>,
}

impl GetApplicationSpecificationApi200Response {
    pub fn new() -> GetApplicationSpecificationApi200Response {
        GetApplicationSpecificationApi200Response {
            status: None,
            data: None,
        }
    }
