...
pub struct GetFluxInfo200ResponseData {
    #[serde(rename = "daemon", skip_serializing_if = "Option::is_none")]
    pub daemon: Option<Box<crate::models::GetFluxInfo200ResponseDataDaemon>>,
    #[serde(rename = "node", skip_serializing_if = "Option::is_none")]
    pub node: Option<Box<crate::models::GetFluxInfo200ResponseDataNode>>,
    #[serde(rename = "benchmark", skip_serializing_if = "Option::is_none")]
    pub benchmark: Option<Box<crate::models::GetFluxInfo200ResponseDataBenchmark>>,
    #[serde(rename = "flux", skip_serializing_if = "Option::is_none")]
    pub flux: Option<Box<crate::models::GetFluxInfo200ResponseDataFlux>>,
    #[serde(rename = "apps", skip_serializing_if = "Option::is_none")]
    pub apps: Option<Box<crate::models::GetFluxInfo200ResponseDataApps>>,
    #[serde(rename = "geolocation", skip_serializing_if = "Option::is_none")]
    pub geolocation: Option<Box<crate::models::Geolocation>>,
    #[serde(rename = "appsHashesTotal", skip_serializing_if = "Option::is_none")]
    pub apps_hashes_total: Option<i32>,
    #[serde(rename = "hashesPresent", skip_serializing_if = "Option::is_none")]
    pub hashes_present: Option<i32>,
}

impl GetFluxInfo200ResponseData {
    pub fn new() -> GetFluxInfo200ResponseData {
        GetFluxInfo200ResponseData {
            daemon: None,
            node: None,
            benchmark: None,
            flux: None,
