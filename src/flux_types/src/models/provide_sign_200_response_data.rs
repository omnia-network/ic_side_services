...
pub struct ProvideSign200ResponseData {
    ...
    /// Start date and time of vaild message
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    /// End date and and time of valid message
...
impl ProvideSign200ResponseData {
    pub fn new() -> ProvideSign200ResponseData {
        ProvideSign200ResponseData {
            signature: None,
            identifier: None,
            created_at: None,
            expired_at: None,
