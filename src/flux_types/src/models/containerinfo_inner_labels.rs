...
/// ContainerinfoInnerLabels : User-defined key/value metadata



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContainerinfoInnerLabels {
    /// Description of app
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
    /// Name/alias of creator/maintainer of app
...
impl ContainerinfoInnerLabels {
    /// User-defined key/value metadata
    pub fn new() -> ContainerinfoInnerLabels {
        ContainerinfoInnerLabels {
            description: None,
            maintainer: None,
            repository: None,
            version: None,
