...
pub struct CreateMultiSig200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Createmultisig>>,
}

impl CreateMultiSig200Response {
    pub fn new() -> CreateMultiSig200Response {
        CreateMultiSig200Response {
            status: None,
            data: None,
        }
    }
