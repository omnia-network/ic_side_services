...
pub struct FluxSyncthingSystemErrorGet200ResponseData {
    #[serde(rename = "errors", skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<crate::models::FluxSyncthingSystemErrorGet200ResponseDataErrorsInner>>,
}

impl FluxSyncthingSystemErrorGet200ResponseData {
    pub fn new() -> FluxSyncthingSystemErrorGet200ResponseData {
        FluxSyncthingSystemErrorGet200ResponseData {
            errors: None,
        }
    }
}
