...
pub struct GetFluxNodeOutputs200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetFluxNodeOutputs200ResponseDataInner>>,
}

impl GetFluxNodeOutputs200Response {
    pub fn new() -> GetFluxNodeOutputs200Response {
        GetFluxNodeOutputs200Response {
            status: None,
            data: None,
        }
    }
