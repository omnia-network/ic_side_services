...
pub struct GetTransaction200ResponseData {
    /// The transaction amount in FLUX
    ...
    pub details: Option<Vec<crate::models::GetTransaction200ResponseDataDetailsInner>>,
    /// Raw data for transaction
    #[serde(rename = "hex", skip_serializing_if = "Option::is_none")]
    pub hex: Option<String>,
}

impl GetTransaction200ResponseData {
    pub fn new() -> GetTransaction200ResponseData {
