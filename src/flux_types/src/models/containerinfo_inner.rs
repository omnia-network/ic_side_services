...
pub struct ContainerinfoInner {
    ...
    /// When the container was created in epoch time
    #[serde(rename = "Created", skip_serializing_if = "Option::is_none")]
    pub created: Option<i32>,
    #[serde(rename = "Ports", skip_serializing_if = "Option::is_none")]
    pub ports: Option<Vec<crate::models::ContainerinfoInnerPortsInner>>,
    #[serde(rename = "Labels", skip_serializing_if = "Option::is_none")]
    pub labels: Option<Box<crate::models::ContainerinfoInnerLabels>>,
    /// State/status of the container
...
impl ContainerinfoInner {
    pub fn new() -> ContainerinfoInner {
        ContainerinfoInner {
            id: None,
            names: None,
            image: None,
