...
pub struct GetFluxNodeCount200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetFluxNodeCount200ResponseData>>,
}

impl GetFluxNodeCount200Response {
    pub fn new() -> GetFluxNodeCount200Response {
        GetFluxNodeCount200Response {
            status: None,
            data: None,
        }
    }
