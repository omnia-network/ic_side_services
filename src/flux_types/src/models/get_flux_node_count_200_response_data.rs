...
pub struct GetFluxNodeCount200ResponseData {
    /// Total number of Flux nodes
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<f32>,
    /// Number of stable Flux nodes
    #[serde(rename = "stable", skip_serializing_if = "Option::is_none")]
    pub stable: Option<f32>,
    /// Basic Flux node count
    #[serde(rename = "basic-enabled", skip_serializing_if = "Option::is_none")]
    pub basic_enabled: Option<f32>,
    /// Super Flux node count
    #[serde(rename = "super-enabled", skip_serializing_if = "Option::is_none")]
    pub super_enabled: Option<f32>,
    /// Bamf Flux node count
    #[serde(rename = "bamf-enabled", skip_serializing_if = "Option::is_none")]
    pub bamf_enabled: Option<f32>,
    /// Flux nodes on ipv4
...
impl GetFluxNodeCount200ResponseData {
    pub fn new() -> GetFluxNodeCount200ResponseData {
        GetFluxNodeCount200ResponseData {
            total: None,
            stable: None,
            basic_enabled: None,
            super_enabled: None,
