...
pub struct ListLockUnspent200ResponseDataInner {
    /// The transaction id
...
impl ListLockUnspent200ResponseDataInner {
    pub fn new() -> ListLockUnspent200ResponseDataInner {
        ListLockUnspent200ResponseDataInner {
            txid: None,
            vout: None,
        }
    }
