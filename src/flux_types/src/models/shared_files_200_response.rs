...
pub struct SharedFiles200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::SharedFiles200ResponseDataInner>>,
}

impl SharedFiles200Response {
    pub fn new() -> SharedFiles200Response {
        SharedFiles200Response {
            status: None,
            data: None,
        }
    }
