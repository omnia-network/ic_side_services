...
pub struct ZListUnspent200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ZListUnspent200ResponseDataInner>>,
}

impl ZListUnspent200Response {
    pub fn new() -> ZListUnspent200Response {
        ZListUnspent200Response {
            status: None,
            data: None,
        }
    }
