...
pub struct SignRawTransaction200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Signrawtransaction>>,
}

impl SignRawTransaction200Response {
    pub fn new() -> SignRawTransaction200Response {
        SignRawTransaction200Response {
            status: None,
            data: None,
        }
    }
