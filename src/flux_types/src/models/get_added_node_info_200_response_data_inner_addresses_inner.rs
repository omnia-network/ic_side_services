...
pub struct GetAddedNodeInfo200ResponseDataInnerAddressesInner {
    /// The Flux server host and port
...
impl GetAddedNodeInfo200ResponseDataInnerAddressesInner {
    pub fn new() -> GetAddedNodeInfo200ResponseDataInnerAddressesInner {
        GetAddedNodeInfo200ResponseDataInnerAddressesInner {
            address: None,
            connected: None,
        }
    }
