...
pub struct AllowPortApi200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::AllowPortApi200ResponseData>>,
}

impl AllowPortApi200Response {
    pub fn new() -> AllowPortApi200Response {
        AllowPortApi200Response {
            status: None,
            data: None,
        }
    }
