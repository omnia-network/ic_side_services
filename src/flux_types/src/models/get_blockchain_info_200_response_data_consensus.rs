...
pub struct GetBlockchainInfo200ResponseDataConsensus {
    /// Branch ID used to validate the current chain tip
    #[serde(rename = "chaintip", skip_serializing_if = "Option::is_none")]
    pub chaintip: Option<String>,
    /// Branch ID that the next block will be validated under
    #[serde(rename = "nextblock", skip_serializing_if = "Option::is_none")]
    pub nextblock: Option<String>,
}

impl GetBlockchainInfo200ResponseDataConsensus {
    pub fn new() -> GetBlockchainInfo200ResponseDataConsensus {
        GetBlockchainInfo200ResponseDataConsensus {
            chaintip: None,
            nextblock: None,
        }
    }
