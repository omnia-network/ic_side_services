...
pub struct InstalledApps200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::InstalledApps200ResponseDataInner>>,
}

impl InstalledApps200Response {
    pub fn new() -> InstalledApps200Response {
        InstalledApps200Response {
            status: None,
            data: None,
        }
    }
