...
pub struct ZoperationstatusInnerParamsAmountsInner {
    /// Receiving address
...
impl ZoperationstatusInnerParamsAmountsInner {
    pub fn new() -> ZoperationstatusInnerParamsAmountsInner {
        ZoperationstatusInnerParamsAmountsInner {
            address: None,
            amount: None,
        }
    }
