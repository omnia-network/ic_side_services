...
pub struct GetMiningInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetMiningInfo200ResponseData>>,
}

impl GetMiningInfo200Response {
    pub fn new() -> GetMiningInfo200Response {
        GetMiningInfo200Response {
            status: None,
            data: None,
        }
    }
