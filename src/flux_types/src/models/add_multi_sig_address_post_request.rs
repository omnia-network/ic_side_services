...
pub struct AddMultiSigAddressPostRequest {
    /// The number of required signatures out of the n keys or addresses
    #[serde(rename = "n", skip_serializing_if = "Option::is_none")]
    pub n: Option<String>,
    /// A json array of Flux addresses or hex-encoded public keys.
    #[serde(rename = "keysobject", skip_serializing_if = "Option::is_none")]
    pub keysobject: Option<Vec<String>>,
}

impl AddMultiSigAddressPostRequest {
    pub fn new() -> AddMultiSigAddressPostRequest {
        AddMultiSigAddressPostRequest {
            n: None,
            keysobject: None,
        }
    }
