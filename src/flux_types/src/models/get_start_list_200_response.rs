...
pub struct GetStartList200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetStartList200ResponseDataInner>>,
}

impl GetStartList200Response {
    pub fn new() -> GetStartList200Response {
        GetStartList200Response {
            status: None,
            data: None,
        }
    }
