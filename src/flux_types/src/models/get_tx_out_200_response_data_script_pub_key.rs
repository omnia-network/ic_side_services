...
pub struct GetTxOut200ResponseDataScriptPubKey {
    /// Script public key
...
impl GetTxOut200ResponseDataScriptPubKey {
    pub fn new() -> GetTxOut200ResponseDataScriptPubKey {
        GetTxOut200ResponseDataScriptPubKey {
            asm: None,
            hex: None,
            req_sigs: None,
            r#type: None,
