...
pub struct LoggedUsers200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::LoggedUsers200ResponseDataInner>>,
}

impl LoggedUsers200Response {
    pub fn new() -> LoggedUsers200Response {
        LoggedUsers200Response {
            status: None,
            data: None,
        }
    }
