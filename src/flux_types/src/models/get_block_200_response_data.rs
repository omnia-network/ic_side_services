...
pub struct GetBlock200ResponseData {
    /// The block hash
    #[serde(rename = "hash", skip_serializing_if = "Option::is_none")]
    pub hash: Option<String>,
    /// The number of confirmations or -1 if on wrong chain
    ...
    pub value_pools: Option<Vec<crate::models::GetBlock200ResponseDataValuePoolsInner>>,
...
impl GetBlock200ResponseData {
    pub fn new() -> GetBlock200ResponseData {
        GetBlock200ResponseData {
            hash: None,
            confirmations: None,
            size: None,
            height: None,
