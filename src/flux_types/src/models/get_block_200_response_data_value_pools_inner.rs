...
pub struct GetBlock200ResponseDataValuePoolsInner {
    /// Protocol name of pool(sprout,sapling)
    #[serde(rename = "id", skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    /// Status of pool monitor
    #[serde(rename = "monitored", skip_serializing_if = "Option::is_none")]
    pub monitored: Option<bool>,
    /// Pool value of FLUX
    #[serde(rename = "chainValue", skip_serializing_if = "Option::is_none")]
    pub chain_value: Option<f32>,
    /// Pool value of FLUX
    #[serde(rename = "chainValueZat", skip_serializing_if = "Option::is_none")]
    pub chain_value_zat: Option<i32>,
    /// Delta value
    ...
    pub value_delta_zat: Option<i32>,
}

impl GetBlock200ResponseDataValuePoolsInner {
    pub fn new() -> GetBlock200ResponseDataValuePoolsInner {
        GetBlock200ResponseDataValuePoolsInner {
            id: None,
            monitored: None,
            chain_value: None,
