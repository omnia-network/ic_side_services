...
pub struct GetBlockchainInfo200ResponseDataSoftforksInner {
    /// Name of softfork
    ...
    pub enforce: Option<Box<crate::models::GetBlockchainInfo200ResponseDataSoftforksInnerEnforce>>,
    #[serde(rename = "reject", skip_serializing_if = "Option::is_none")]
    pub reject: Option<Box<crate::models::GetBlockchainInfo200ResponseDataSoftforksInnerEnforce>>,
}

impl GetBlockchainInfo200ResponseDataSoftforksInner {
    pub fn new() -> GetBlockchainInfo200ResponseDataSoftforksInner {
        GetBlockchainInfo200ResponseDataSoftforksInner {
            id: None,
            version: None,
            enforce: None,
            reject: None,
