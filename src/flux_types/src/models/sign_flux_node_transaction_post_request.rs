...
pub struct SignFluxNodeTransactionPostRequest {
...
impl SignFluxNodeTransactionPostRequest {
    pub fn new() -> SignFluxNodeTransactionPostRequest {
        SignFluxNodeTransactionPostRequest {
            hexstring: None,
        }
    }
}
