...
pub struct GetNetworkInfo200ResponseDataNetworksInner {
    ...
    /// Does proxy randomize credentials?
    #[serde(rename = "proxy_randomize_credentials", skip_serializing_if = "Option::is_none")]
    pub proxy_randomize_credentials: Option<bool>,
}

impl GetNetworkInfo200ResponseDataNetworksInner {
    pub fn new() -> GetNetworkInfo200ResponseDataNetworksInner {
        GetNetworkInfo200ResponseDataNetworksInner {
            name: None,
            limited: None,
            reachable: None,
            proxy: None,
