...
pub struct FluxSyncthingPendingDevicesPostRequest {
    #[serde(rename = "device", skip_serializing_if = "Option::is_none")]
    pub device: Option<String>,
}

impl FluxSyncthingPendingDevicesPostRequest {
    pub fn new() -> FluxSyncthingPendingDevicesPostRequest {
        FluxSyncthingPendingDevicesPostRequest {
            device: None,
        }
    }
}
