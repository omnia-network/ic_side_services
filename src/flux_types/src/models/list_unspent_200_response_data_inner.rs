...
pub struct ListUnspent200ResponseDataInner {
    /// Tranaction id
    ...
    /// The associated account, or \"\" for the default account
...
impl ListUnspent200ResponseDataInner {
    pub fn new() -> ListUnspent200ResponseDataInner {
        ListUnspent200ResponseDataInner {
            txid: None,
            vout: None,
            generated: None,
            address: None,
