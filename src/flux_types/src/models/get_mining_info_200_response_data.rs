...
pub struct GetMiningInfo200ResponseData {
    /// The current block
    ...
    #[serde(rename = "genproclimit", skip_serializing_if = "Option::is_none")]
    pub genproclimit: Option<i32>,
    /// The average local solution rate in Sol/s since this node was started
    #[serde(rename = "localsolps", skip_serializing_if = "Option::is_none")]
    pub localsolps: Option<i32>,
    /// The estimated network solution rate in Sol/s
    #[serde(rename = "networksolps", skip_serializing_if = "Option::is_none")]
    pub networksolps: Option<i32>,
    /// The estimated network hash rate in Hash/s
    #[serde(rename = "networkhashps", skip_serializing_if = "Option::is_none")]
    pub networkhashps: Option<i32>,
    /// The size of the mem pool
    #[serde(rename = "pooledtx", skip_serializing_if = "Option::is_none")]
    pub pooledtx: Option<i32>,
...
impl GetMiningInfo200ResponseData {
    pub fn new() -> GetMiningInfo200ResponseData {
        GetMiningInfo200ResponseData {
            blocks: None,
