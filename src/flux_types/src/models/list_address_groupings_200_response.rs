...
pub struct ListAddressGroupings200Response {
...
impl ListAddressGroupings200Response {
    pub fn new() -> ListAddressGroupings200Response {
        ListAddressGroupings200Response {
            status: None,
            data: None,
        }
    }
