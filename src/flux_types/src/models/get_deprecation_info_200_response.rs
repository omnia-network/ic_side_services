...
pub struct GetDeprecationInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetDeprecationInfo200ResponseData>>,
}

impl GetDeprecationInfo200Response {
    pub fn new() -> GetDeprecationInfo200Response {
        GetDeprecationInfo200Response {
            status: None,
            data: None,
        }
    }
