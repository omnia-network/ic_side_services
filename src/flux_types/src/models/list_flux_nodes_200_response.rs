...
pub struct ListFluxNodes200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ListFluxNodes200ResponseDataInner>>,
}

impl ListFluxNodes200Response {
    pub fn new() -> ListFluxNodes200Response {
        ListFluxNodes200Response {
            status: None,
            data: None,
        }
    }
