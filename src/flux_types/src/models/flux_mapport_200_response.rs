...
pub struct FluxMapport200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxMapport200ResponseData>>,
}

impl FluxMapport200Response {
    pub fn new() -> FluxMapport200Response {
        FluxMapport200Response {
            status: None,
            data: None,
        }
    }
