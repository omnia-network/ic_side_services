...
pub struct FluxSyncthingConfigIgnores200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxSyncthingConfigIgnores200ResponseData>>,
}

impl FluxSyncthingConfigIgnores200Response {
    pub fn new() -> FluxSyncthingConfigIgnores200Response {
        FluxSyncthingConfigIgnores200Response {
            status: None,
            data: None,
        }
    }
