...
pub struct GetAddressBalance200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Flux balance in satoshi value
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<i32>,
}

impl GetAddressBalance200Response {
    pub fn new() -> GetAddressBalance200Response {
        GetAddressBalance200Response {
            status: None,
            data: None,
        }
    }
