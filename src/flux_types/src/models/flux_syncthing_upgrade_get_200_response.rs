...
pub struct FluxSyncthingUpgradeGet200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxSyncthingUpgradeGet200ResponseData>>,
}

impl FluxSyncthingUpgradeGet200Response {
    pub fn new() -> FluxSyncthingUpgradeGet200Response {
        FluxSyncthingUpgradeGet200Response {
            status: None,
            data: None,
        }
    }
