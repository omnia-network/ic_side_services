...
pub struct InstalledApps200ResponseDataInner {
    /// App id
...
impl InstalledApps200ResponseDataInner {
    pub fn new() -> InstalledApps200ResponseDataInner {
        InstalledApps200ResponseDataInner {
            _id: None,
            repotag: None,
            name: None,
            port: None,
