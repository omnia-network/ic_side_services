...
pub struct ViewDeterministicFluxNodeList200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ViewDeterministicFluxNodeList200ResponseDataInner>>,
}

impl ViewDeterministicFluxNodeList200Response {
    pub fn new() -> ViewDeterministicFluxNodeList200Response {
        ViewDeterministicFluxNodeList200Response {
            status: None,
            data: None,
        }
    }
