...
pub struct SignMessagePostRequest {
    /// The transparent address to use for the private key
    #[serde(rename = "taddr", skip_serializing_if = "Option::is_none")]
...
impl SignMessagePostRequest {
    pub fn new() -> SignMessagePostRequest {
        SignMessagePostRequest {
            taddr: None,
            message: None,
        }
    }
