...
pub struct GetFluxNodeOutputs200ResponseDataInner {
    /// Output transaction hash
    #[serde(rename = "txhash", skip_serializing_if = "Option::is_none")]
    pub txhash: Option<String>,
    /// Output index number
    #[serde(rename = "outputidx", skip_serializing_if = "Option::is_none")]
    pub outputidx: Option<f32>,
}

impl GetFluxNodeOutputs200ResponseDataInner {
    pub fn new() -> GetFluxNodeOutputs200ResponseDataInner {
        GetFluxNodeOutputs200ResponseDataInner {
            txhash: None,
            outputidx: None,
        }
    }
