...
pub struct FluxNodeCurrentWinner200ResponseData {
    #[serde(rename = "CUMULUS Winner", skip_serializing_if = "Option::is_none")]
    pub cumulus_winner: Option<Box<crate::models::FluxNodeCurrentWinner200ResponseDataCumulusWinner>>,
    #[serde(rename = "NIMMBUS Winner", skip_serializing_if = "Option::is_none")]
    pub nimmbus_winner: Option<Box<crate::models::FluxNodeCurrentWinner200ResponseDataCumulusWinner>>,
    #[serde(rename = "STRATUS Winner", skip_serializing_if = "Option::is_none")]
    pub stratus_winner: Option<Box<crate::models::FluxNodeCurrentWinner200ResponseDataCumulusWinner>>,
}

impl FluxNodeCurrentWinner200ResponseData {
    pub fn new() -> FluxNodeCurrentWinner200ResponseData {
        FluxNodeCurrentWinner200ResponseData {
            cumulus_winner: None,
            nimmbus_winner: None,
            stratus_winner: None,
        }
