...
/// RegistrationInformation200ResponseDataPrice : Price guide



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct RegistrationInformation200ResponseDataPrice {
    /// FLUX amount per 0.1 cpu core
    #[serde(rename = "cpu", skip_serializing_if = "Option::is_none")]
    pub cpu: Option<i32>,
    /// FLUX amount per 100 mb
    #[serde(rename = "ram", skip_serializing_if = "Option::is_none")]
    pub ram: Option<i32>,
    /// FLUX amount per 1 gb
    #[serde(rename = "hdd", skip_serializing_if = "Option::is_none")]
    pub hdd: Option<f32>,
}

impl RegistrationInformation200ResponseDataPrice {
    /// Price guide
    pub fn new() -> RegistrationInformation200ResponseDataPrice {
        RegistrationInformation200ResponseDataPrice {
            cpu: None,
            ram: None,
            hdd: None,
        }
