...
pub struct SignRawTransactionPostRequestPrevtxsInner {
    /// The transaction id
...
impl SignRawTransactionPostRequestPrevtxsInner {
    pub fn new() -> SignRawTransactionPostRequestPrevtxsInner {
        SignRawTransactionPostRequestPrevtxsInner {
            txid: None,
            vout: None,
            script_pub_key: None,
            redeem_script: None,
