...
pub struct ListReceivedByAddress200ResponseDataInner {
    /// Only returned if imported addresses were involved in transaction
    #[serde(rename = "involvesWatchonly", skip_serializing_if = "Option::is_none")]
    ...
    /// The total amount in FLUX received by the address
...
impl ListReceivedByAddress200ResponseDataInner {
    pub fn new() -> ListReceivedByAddress200ResponseDataInner {
        ListReceivedByAddress200ResponseDataInner {
            involves_watchonly: None,
            address: None,
            account: None,
            amount: None,
            confirmations: None,
