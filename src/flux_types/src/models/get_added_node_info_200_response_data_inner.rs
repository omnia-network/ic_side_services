...
pub struct GetAddedNodeInfo200ResponseDataInner {
    /// The node ip address
    #[serde(rename = "addednode", skip_serializing_if = "Option::is_none")]
    pub addednode: Option<String>,
    /// If connected
    #[serde(rename = "connected", skip_serializing_if = "Option::is_none")]
    pub connected: Option<bool>,
    #[serde(rename = "addresses", skip_serializing_if = "Option::is_none")]
    pub addresses: Option<Vec<crate::models::GetAddedNodeInfo200ResponseDataInnerAddressesInner>>,
}

impl GetAddedNodeInfo200ResponseDataInner {
    pub fn new() -> GetAddedNodeInfo200ResponseDataInner {
        GetAddedNodeInfo200ResponseDataInner {
            addednode: None,
            connected: None,
            addresses: None,
        }
