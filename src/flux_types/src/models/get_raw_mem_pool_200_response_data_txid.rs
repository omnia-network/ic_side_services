...
pub struct GetRawMemPool200ResponseDataTxid {
    /// Transaction size in bytes
    #[serde(rename = "size", skip_serializing_if = "Option::is_none")]
    pub size: Option<i32>,
    /// Transaction fee in FLUX
    ...
    #[serde(rename = "startingpriority", skip_serializing_if = "Option::is_none")]
    pub startingpriority: Option<i32>,
    /// Transaction priority now
    #[serde(rename = "currentpriority", skip_serializing_if = "Option::is_none")]
    pub currentpriority: Option<i32>,
    #[serde(rename = "depends", skip_serializing_if = "Option::is_none")]
    pub depends: Option<Vec<String>>,
}

impl GetRawMemPool200ResponseDataTxid {
    pub fn new() -> GetRawMemPool200ResponseDataTxid {
        GetRawMemPool200ResponseDataTxid {
            size: None,
            fee: None,
            time: None,
            height: None,
            startingpriority: None,
