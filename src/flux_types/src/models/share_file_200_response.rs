...
pub struct ShareFile200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ShareFile200ResponseData>>,
}

impl ShareFile200Response {
    pub fn new() -> ShareFile200Response {
        ShareFile200Response {
            status: None,
            data: None,
        }
    }
