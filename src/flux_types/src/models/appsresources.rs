...
pub struct Appsresources {
    /// Amount of cores app is using
    #[serde(rename = "appsCpusLocked", skip_serializing_if = "Option::is_none")]
    pub apps_cpus_locked: Option<f32>,
    /// Amount of ram app is using
    #[serde(rename = "appsRamLocked", skip_serializing_if = "Option::is_none")]
    pub apps_ram_locked: Option<i32>,
    /// Amount of disk space app is using
    #[serde(rename = "appsHddLocked", skip_serializing_if = "Option::is_none")]
    pub apps_hdd_locked: Option<i32>,
}

impl Appsresources {
    pub fn new() -> Appsresources {
        Appsresources {
            apps_cpus_locked: None,
            apps_ram_locked: None,
            apps_hdd_locked: None,
        }
    }
}
