...
pub struct CreateRawTransactionTransactionsParameter {
}

impl CreateRawTransactionTransactionsParameter {
    pub fn new() -> CreateRawTransactionTransactionsParameter {
        CreateRawTransactionTransactionsParameter {
        }
    }
}
