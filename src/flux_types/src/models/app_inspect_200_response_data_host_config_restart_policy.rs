...
pub struct AppInspect200ResponseDataHostConfigRestartPolicy {
    /// Policy name
...
impl AppInspect200ResponseDataHostConfigRestartPolicy {
    pub fn new() -> AppInspect200ResponseDataHostConfigRestartPolicy {
        AppInspect200ResponseDataHostConfigRestartPolicy {
            name: None,
