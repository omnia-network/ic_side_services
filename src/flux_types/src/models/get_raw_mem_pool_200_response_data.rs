...
pub struct GetRawMemPool200ResponseData {
    #[serde(rename = "txid", skip_serializing_if = "Option::is_none")]
    pub txid: Option<Box<crate::models::GetRawMemPool200ResponseDataTxid>>,
}

impl GetRawMemPool200ResponseData {
    pub fn new() -> GetRawMemPool200ResponseData {
        GetRawMemPool200ResponseData {
            txid: None,
        }
    }
}
