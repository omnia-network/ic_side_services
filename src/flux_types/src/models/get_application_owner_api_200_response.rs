...
pub struct GetApplicationOwnerApi200Response {
...
impl GetApplicationOwnerApi200Response {
    pub fn new() -> GetApplicationOwnerApi200Response {
        GetApplicationOwnerApi200Response {
            status: None,
            data: None,
        }
    }
