...
pub struct CheckDockerAccessibilityRequest {
...
impl CheckDockerAccessibilityRequest {
    pub fn new() -> CheckDockerAccessibilityRequest {
        CheckDockerAccessibilityRequest {
            repotag: None,
        }
    }
}
