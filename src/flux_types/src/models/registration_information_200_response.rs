...
pub struct RegistrationInformation200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::RegistrationInformation200ResponseData>>,
}

impl RegistrationInformation200Response {
    pub fn new() -> RegistrationInformation200Response {
        RegistrationInformation200Response {
            status: None,
            data: None,
        }
    }
