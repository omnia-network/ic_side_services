...
pub struct GetFluxInfo200ResponseDataFlux {
    /// Version number
    ...
    /// If ``true`` node have a static IP address
    #[serde(rename = "staticIp", skip_serializing_if = "Option::is_none")]
    pub static_ip: Option<bool>,
    /// Admin's ZelID
    #[serde(rename = "zelid", skip_serializing_if = "Option::is_none")]
    pub zelid: Option<String>,
    /// PGP identity
    #[serde(rename = "pgp", skip_serializing_if = "Option::is_none")]
    pub pgp: Option<String>,
    /// Cruxid address
    #[serde(rename = "cruxid", skip_serializing_if = "Option::is_none")]
    pub cruxid: Option<String>,
    /// Server's timezone
    #[serde(rename = "timezone", skip_serializing_if = "Option::is_none")]
    pub timezone: Option<String>,
    #[serde(rename = "dos", skip_serializing_if = "Option::is_none")]
    pub dos: Option<Box<crate::models::GetFluxInfo200ResponseDataFluxDos>>,
    #[serde(rename = "appsDos", skip_serializing_if = "Option::is_none")]
    pub apps_dos: Option<Box<crate::models::GetFluxInfo200ResponseDataFluxDos>>,
    /// If ```true``` development branch is active
    #[serde(rename = "development", skip_serializing_if = "Option::is_none")]
    pub development: Option<bool>,
    #[serde(rename = "explorerScannedHeigth", skip_serializing_if = "Option::is_none")]
    pub explorer_scanned_heigth: Option<Box<crate::models::GetFluxInfo200ResponseDataFluxExplorerScannedHeigth>>,
    #[serde(rename = "numberOfConnectionsOut", skip_serializing_if = "Option::is_none")]
    pub number_of_connections_out: Option<i32>,
    #[serde(rename = "numberOfConnectionsIn", skip_serializing_if = "Option::is_none")]
    pub number_of_connections_in: Option<i32>,
}

impl GetFluxInfo200ResponseDataFlux {
    pub fn new() -> GetFluxInfo200ResponseDataFlux {
        GetFluxInfo200ResponseDataFlux {
            version: None,
            ip: None,
            static_ip: None,
            zelid: None,
            ...
            apps_dos: None,
            development: None,
            explorer_scanned_heigth: None,
            number_of_connections_out: None,
            number_of_connections_in: None,
        }
    }
}
