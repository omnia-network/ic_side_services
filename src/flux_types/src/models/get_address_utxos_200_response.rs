...
pub struct GetAddressUtxos200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetAddressUtxos200ResponseDataInner>>,
}

impl GetAddressUtxos200Response {
    pub fn new() -> GetAddressUtxos200Response {
        GetAddressUtxos200Response {
            status: None,
            data: None,
        }
    }
