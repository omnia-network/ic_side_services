...
pub struct GetNetTotals200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetNetTotals200ResponseData>>,
}

impl GetNetTotals200Response {
    pub fn new() -> GetNetTotals200Response {
        GetNetTotals200Response {
            status: None,
            data: None,
        }
    }
