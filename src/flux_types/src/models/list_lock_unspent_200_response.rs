...
pub struct ListLockUnspent200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ListLockUnspent200ResponseDataInner>>,
}

impl ListLockUnspent200Response {
    pub fn new() -> ListLockUnspent200Response {
        ListLockUnspent200Response {
            status: None,
            data: None,
        }
    }
