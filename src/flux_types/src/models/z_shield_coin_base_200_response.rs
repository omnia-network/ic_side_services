...
pub struct ZShieldCoinBase200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ZShieldCoinBase200ResponseData>>,
}

impl ZShieldCoinBase200Response {
    pub fn new() -> ZShieldCoinBase200Response {
        ZShieldCoinBase200Response {
            status: None,
            data: None,
        }
    }
