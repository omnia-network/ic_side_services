...
/// SignrawtransactionErrors : Script verification errors (if there are any)



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct SignrawtransactionErrors {
...
impl SignrawtransactionErrors {
    /// Script verification errors (if there are any)
    pub fn new() -> SignrawtransactionErrors {
