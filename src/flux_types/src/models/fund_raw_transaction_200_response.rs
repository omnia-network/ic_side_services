...
pub struct FundRawTransaction200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Fundrawtransaction>>,
}

impl FundRawTransaction200Response {
    pub fn new() -> FundRawTransaction200Response {
        FundRawTransaction200Response {
            status: None,
            data: None,
        }
    }
