...
pub struct GetNetworkHashPs200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Estimated network solutions per second
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<i32>,
}

impl GetNetworkHashPs200Response {
    pub fn new() -> GetNetworkHashPs200Response {
        GetNetworkHashPs200Response {
            status: None,
            data: None,
        }
    }
