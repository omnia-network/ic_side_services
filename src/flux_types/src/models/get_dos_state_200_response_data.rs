...
pub struct GetDosState200ResponseData {
    /// Status number
    #[serde(rename = "dosState", skip_serializing_if = "Option::is_none")]
    pub dos_state: Option<i32>,
    /// Explanation of status
    #[serde(rename = "dosMessage", skip_serializing_if = "Option::is_none")]
    pub dos_message: Option<String>,
}

impl GetDosState200ResponseData {
    pub fn new() -> GetDosState200ResponseData {
        GetDosState200ResponseData {
            dos_state: None,
            dos_message: None,
        }
    }
