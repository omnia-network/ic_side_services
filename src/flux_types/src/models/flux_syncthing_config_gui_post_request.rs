...
pub struct FluxSyncthingConfigGuiPostRequest {
    #[serde(rename = "config", skip_serializing_if = "Option::is_none")]
    pub config: Option<Box<crate::models::FluxSyncthingConfigGuiPostRequestConfig>>,
}

impl FluxSyncthingConfigGuiPostRequest {
    pub fn new() -> FluxSyncthingConfigGuiPostRequest {
        FluxSyncthingConfigGuiPostRequest {
            config: None,
        }
    }
}
