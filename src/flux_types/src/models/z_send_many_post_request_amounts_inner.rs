...
pub struct ZSendManyPostRequestAmountsInner {
    /// The taddr or zaddr to send the funds from
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
    /// The numeric amount in FLUX is the value
    #[serde(rename = "amount", skip_serializing_if = "Option::is_none")]
    pub amount: Option<f32>,
    /// If the address is a zaddr, raw data represented in hexadecimal string format. (optional)
    #[serde(rename = "memo", skip_serializing_if = "Option::is_none")]
    pub memo: Option<String>,
}

impl ZSendManyPostRequestAmountsInner {
    pub fn new() -> ZSendManyPostRequestAmountsInner {
        ZSendManyPostRequestAmountsInner {
            address: None,
            amount: None,
            memo: None,
        }
