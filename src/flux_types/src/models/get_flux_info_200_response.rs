...
pub struct GetFluxInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetFluxInfo200ResponseData>>,
}

impl GetFluxInfo200Response {
    pub fn new() -> GetFluxInfo200Response {
        GetFluxInfo200Response {
            status: None,
            data: None,
        }
    }
