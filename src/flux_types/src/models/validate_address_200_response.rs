...
pub struct ValidateAddress200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ValidateAddress200ResponseData>>,
}

impl ValidateAddress200Response {
    pub fn new() -> ValidateAddress200Response {
