...
pub struct FluxSyncthingSystemVersion200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FluxSyncthingSystemVersion200ResponseData>>,
}

impl FluxSyncthingSystemVersion200Response {
    pub fn new() -> FluxSyncthingSystemVersion200Response {
        FluxSyncthingSystemVersion200Response {
            status: None,
            data: None,
        }
    }
