...
pub struct GetWalletInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetWalletInfo200ResponseData>>,
}

impl GetWalletInfo200Response {
    pub fn new() -> GetWalletInfo200Response {
        GetWalletInfo200Response {
            status: None,
            data: None,
        }
    }
