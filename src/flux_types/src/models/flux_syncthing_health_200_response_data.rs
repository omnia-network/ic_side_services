...
pub struct FluxSyncthingHealth200ResponseData {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}

impl FluxSyncthingHealth200ResponseData {
    pub fn new() -> FluxSyncthingHealth200ResponseData {
        FluxSyncthingHealth200ResponseData {
            status: None,
        }
    }
}
