...
pub struct GetTxOutSetInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetTxOutSetInfo200ResponseData>>,
}

impl GetTxOutSetInfo200Response {
    pub fn new() -> GetTxOutSetInfo200Response {
        GetTxOutSetInfo200Response {
            status: None,
            data: None,
        }
    }
