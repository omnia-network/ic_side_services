...
pub struct ZSendManyPostRequest {
    ...
    pub amounts: Option<Vec<crate::models::ZSendManyPostRequestAmountsInner>>,
...
impl ZSendManyPostRequest {
    pub fn new() -> ZSendManyPostRequest {
        ZSendManyPostRequest {
            fromaddress: None,
            amounts: None,
            minconf: None,
            fee: None,
