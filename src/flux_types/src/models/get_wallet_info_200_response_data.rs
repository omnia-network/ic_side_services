...
pub struct GetWalletInfo200ResponseData {
    /// The wallet version
    #[serde(rename = "walletversion", skip_serializing_if = "Option::is_none")]
    pub walletversion: Option<i32>,
    /// The total confirmed balance of the wallet in FLUX
    #[serde(rename = "balance", skip_serializing_if = "Option::is_none")]
    pub balance: Option<f32>,
    /// The wallet version
    #[serde(rename = "unconfirmed_balance", skip_serializing_if = "Option::is_none")]
    pub unconfirmed_balance: Option<f32>,
    /// The total unconfirmed balance of the wallet in FLUX
    #[serde(rename = "immature_balance", skip_serializing_if = "Option::is_none")]
    pub immature_balance: Option<f32>,
    /// The total number of transactions in the wallet
    #[serde(rename = "txcount", skip_serializing_if = "Option::is_none")]
    pub txcount: Option<i32>,
    ...
    /// The transaction fee configuration, set in FLUX/kB
    #[serde(rename = "paytxfee", skip_serializing_if = "Option::is_none")]
    pub paytxfee: Option<f32>,
    /// The BLAKE2b-256 hash of the HD seed
    #[serde(rename = "seedfp", skip_serializing_if = "Option::is_none")]
    pub seedfp: Option<String>,
}

impl GetWalletInfo200ResponseData {
    pub fn new() -> GetWalletInfo200ResponseData {
        GetWalletInfo200ResponseData {
            walletversion: None,
            balance: None,
