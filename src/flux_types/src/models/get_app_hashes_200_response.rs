...
pub struct GetAppHashes200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetAppHashes200ResponseDataInner>>,
}

impl GetAppHashes200Response {
    pub fn new() -> GetAppHashes200Response {
        GetAppHashes200Response {
            status: None,
            data: None,
        }
    }
