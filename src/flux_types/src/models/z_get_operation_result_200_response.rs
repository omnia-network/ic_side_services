...
pub struct ZGetOperationResult200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ZoperationstatusInner>>,
}

impl ZGetOperationResult200Response {
    pub fn new() -> ZGetOperationResult200Response {
        ZGetOperationResult200Response {
            status: None,
            data: None,
        }
    }
