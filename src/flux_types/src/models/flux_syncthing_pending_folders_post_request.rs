...
pub struct FluxSyncthingPendingFoldersPostRequest {
    #[serde(rename = "folder", skip_serializing_if = "Option::is_none")]
    pub folder: Option<String>,
}

impl FluxSyncthingPendingFoldersPostRequest {
    pub fn new() -> FluxSyncthingPendingFoldersPostRequest {
        FluxSyncthingPendingFoldersPostRequest {
            folder: None,
        }
    }
}
