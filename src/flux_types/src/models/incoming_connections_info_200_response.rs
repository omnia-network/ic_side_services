...
pub struct IncomingConnectionsInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::IncomingConnectionsInfo200ResponseDataInner>>,
}

impl IncomingConnectionsInfo200Response {
    pub fn new() -> IncomingConnectionsInfo200Response {
        IncomingConnectionsInfo200Response {
            status: None,
            data: None,
        }
    }
