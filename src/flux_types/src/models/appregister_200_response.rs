...
pub struct Appregister200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Hash of entire message and will be stored for 1 hour
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<String>,
}

impl Appregister200Response {
    pub fn new() -> Appregister200Response {
        Appregister200Response {
            status: None,
            data: None,
        }
    }
