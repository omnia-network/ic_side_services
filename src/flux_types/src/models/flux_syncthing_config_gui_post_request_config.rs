...
pub struct FluxSyncthingConfigGuiPostRequestConfig {
    #[serde(rename = "enabled", skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
    #[serde(rename = "unixSocketPermissions", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "insecureAdminAccess", skip_serializing_if = "Option::is_none")]
    pub insecure_admin_access: Option<bool>,
    #[serde(rename = "theme", skip_serializing_if = "Option::is_none")]
    pub theme: Option<String>,
    #[serde(rename = "debugging", skip_serializing_if = "Option::is_none")]
    pub debugging: Option<bool>,
    #[serde(rename = "insecureSkipHostcheck", skip_serializing_if = "Option::is_none")]
    pub insecure_skip_hostcheck: Option<bool>,
    #[serde(rename = "insecureAllowFrameLoading", skip_serializing_if = "Option::is_none")]
    pub insecure_allow_frame_loading: Option<bool>,
}

impl FluxSyncthingConfigGuiPostRequestConfig {
    pub fn new() -> FluxSyncthingConfigGuiPostRequestConfig {
        FluxSyncthingConfigGuiPostRequestConfig {
            enabled: None,
            address: None,
            ...
            use_tls: None,
            api_key: None,
            insecure_admin_access: None,
            theme: None,
            debugging: None,
            insecure_skip_hostcheck: None,
            insecure_allow_frame_loading: None,
        }
    }
}
