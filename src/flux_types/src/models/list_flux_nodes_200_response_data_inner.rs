...
pub struct ListFluxNodes200ResponseDataInner {
    ...
    /// Active time of Flux node in epoch
...
impl ListFluxNodes200ResponseDataInner {
    pub fn new() -> ListFluxNodes200ResponseDataInner {
        ListFluxNodes200ResponseDataInner {
            collateral: None,
            ip: None,
            network: None,
            added_height: None,
