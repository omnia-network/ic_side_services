...
pub struct GetBlockHeader200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetBlockHeader200ResponseData>>,
}

impl GetBlockHeader200Response {
    pub fn new() -> GetBlockHeader200Response {
        GetBlockHeader200Response {
            status: None,
            data: None,
        }
    }
