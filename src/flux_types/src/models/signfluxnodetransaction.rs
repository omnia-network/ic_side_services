...
pub struct Signfluxnodetransaction {
    ...
    /// Hex encoded info of the transaction
    #[serde(rename = "hex", skip_serializing_if = "Option::is_none")]
    pub hex: Option<String>,
}

impl Signfluxnodetransaction {
    pub fn new() -> Signfluxnodetransaction {
        Signfluxnodetransaction {
            status: None,
            tier: None,
            hex: None,
        }
