...
pub struct AppInspect200ResponseDataState {
    /// State/status of container
    ...
    /// Has memory limit exceeded on container
...
impl AppInspect200ResponseDataState {
    pub fn new() -> AppInspect200ResponseDataState {
        AppInspect200ResponseDataState {
            status: None,
            running: None,
            paused: None,
            restarting: None,
