...
/// AppInspect200ResponseDataHostConfigUlimitsInner : A list of resource limits to set in the container



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppInspect200ResponseDataHostConfigUlimitsInner {
...
impl AppInspect200ResponseDataHostConfigUlimitsInner {
    /// A list of resource limits to set in the container
    pub fn new() -> AppInspect200ResponseDataHostConfigUlimitsInner {
        AppInspect200ResponseDataHostConfigUlimitsInner {
            name: None,
            hard: None,
            soft: None,
        }
