...
pub struct GetFilteredFluxNodeTxs200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetFilteredFluxNodeTxs200ResponseData>>,
}

impl GetFilteredFluxNodeTxs200Response {
    pub fn new() -> GetFilteredFluxNodeTxs200Response {
        GetFilteredFluxNodeTxs200Response {
            status: None,
            data: None,
        }
    }
