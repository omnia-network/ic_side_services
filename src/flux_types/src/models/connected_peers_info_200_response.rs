...
pub struct ConnectedPeersInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ConnectedPeersInfo200ResponseDataInner>>,
}

impl ConnectedPeersInfo200Response {
    pub fn new() -> ConnectedPeersInfo200Response {
        ConnectedPeersInfo200Response {
            status: None,
            data: None,
        }
    }
