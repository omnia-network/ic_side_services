...
pub struct GetRawTransaction200ResponseDataVinInner {
    /// Coinbase hash
...
impl GetRawTransaction200ResponseDataVinInner {
    pub fn new() -> GetRawTransaction200ResponseDataVinInner {
        GetRawTransaction200ResponseDataVinInner {
            coinbase: None,
            sequence: None,
        }
    }
