...
pub struct GetScannedHeight200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetScannedHeight200ResponseData>>,
}

impl GetScannedHeight200Response {
    pub fn new() -> GetScannedHeight200Response {
        GetScannedHeight200Response {
            status: None,
            data: None,
        }
    }
