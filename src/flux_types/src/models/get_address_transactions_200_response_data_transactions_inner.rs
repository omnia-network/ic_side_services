...
pub struct GetAddressTransactions200ResponseDataTransactionsInner {
    /// The transaction id
...
impl GetAddressTransactions200ResponseDataTransactionsInner {
    pub fn new() -> GetAddressTransactions200ResponseDataTransactionsInner {
        GetAddressTransactions200ResponseDataTransactionsInner {
            txid: None,
            height: None,
        }
    }
