...
pub struct GetFluxInfo200ResponseDataFluxDos {
    /// Number indicating value of DOS state from 0 to infinity
    #[serde(rename = "dosState", skip_serializing_if = "Option::is_none")]
    pub dos_state: Option<f32>,
    /// Status message or Null if no message
    #[serde(rename = "dosMessage", skip_serializing_if = "Option::is_none")]
    pub dos_message: Option<String>,
}

impl GetFluxInfo200ResponseDataFluxDos {
    pub fn new() -> GetFluxInfo200ResponseDataFluxDos {
        GetFluxInfo200ResponseDataFluxDos {
            dos_state: None,
            dos_message: None,
        }
    }
