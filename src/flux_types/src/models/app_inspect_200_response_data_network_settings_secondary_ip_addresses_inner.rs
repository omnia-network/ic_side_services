...
/// AppInspect200ResponseDataNetworkSettingsSecondaryIpAddressesInner : Address represents an IPv4 or IPv6 IP address



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppInspect200ResponseDataNetworkSettingsSecondaryIpAddressesInner {
    /// IP address
...
impl AppInspect200ResponseDataNetworkSettingsSecondaryIpAddressesInner {
    /// Address represents an IPv4 or IPv6 IP address
    pub fn new() -> AppInspect200ResponseDataNetworkSettingsSecondaryIpAddressesInner {
        AppInspect200ResponseDataNetworkSettingsSecondaryIpAddressesInner {
            addr: None,
            prefix_len: None,
        }
    }
