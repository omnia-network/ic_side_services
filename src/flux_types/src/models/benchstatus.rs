...
pub struct Benchstatus {
    ...
    /// Tier server passed for CUMULUS/NIMMBUS/STRATUS
    #[serde(rename = "benchmarking", skip_serializing_if = "Option::is_none")]
    pub benchmarking: Option<String>,
    /// Status of Flux backend
    #[serde(rename = "zelback", skip_serializing_if = "Option::is_none")]
    pub zelback: Option<String>,
}

impl Benchstatus {
    pub fn new() -> Benchstatus {
        Benchstatus {
            status: None,
            benchmarking: None,
            zelback: None,
