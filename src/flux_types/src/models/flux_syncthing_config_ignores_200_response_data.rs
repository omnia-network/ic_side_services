...
pub struct FluxSyncthingConfigIgnores200ResponseData {
    #[serde(rename = "requiresRestart", skip_serializing_if = "Option::is_none")]
    pub requires_restart: Option<bool>,
}

impl FluxSyncthingConfigIgnores200ResponseData {
    pub fn new() -> FluxSyncthingConfigIgnores200ResponseData {
        FluxSyncthingConfigIgnores200ResponseData {
