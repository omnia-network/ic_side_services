...
pub struct Streamdata {
    ...
    pub progress_detail: Option<Box<crate::models::StreamdataProgressDetail>>,
    /// Progress bar animation to the download
    ...
    pub data: Option<Box<crate::models::StreamdataData>>,
}
