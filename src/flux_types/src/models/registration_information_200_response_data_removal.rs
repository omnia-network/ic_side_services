...
pub struct RegistrationInformation200ResponseDataRemoval {
    /// Instances it will remove if amount of apps exceed limit at a 1 out of 20 rate.
...
impl RegistrationInformation200ResponseDataRemoval {
    pub fn new() -> RegistrationInformation200ResponseDataRemoval {
        RegistrationInformation200ResponseDataRemoval {
            probability: None,
            delay: None,
        }
    }
