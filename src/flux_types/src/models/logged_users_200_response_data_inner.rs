...
pub struct LoggedUsers200ResponseDataInner {
    /// users ZelID
...
impl LoggedUsers200ResponseDataInner {
    pub fn new() -> LoggedUsers200ResponseDataInner {
        LoggedUsers200ResponseDataInner {
            zelid: None,
            login_phrase: None,
        }
    }
