...
pub struct ListBanned200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ListBanned200ResponseDataInner>>,
}

impl ListBanned200Response {
    pub fn new() -> ListBanned200Response {
        ListBanned200Response {
            status: None,
            data: None,
        }
    }
