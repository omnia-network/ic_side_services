...
pub struct ListUnspent200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ListUnspent200ResponseDataInner>>,
}

impl ListUnspent200Response {
    pub fn new() -> ListUnspent200Response {
        ListUnspent200Response {
            status: None,
            data: None,
        }
    }
