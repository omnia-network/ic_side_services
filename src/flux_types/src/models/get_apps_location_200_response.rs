...
pub struct GetAppsLocation200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::AppslocationInner>>,
}

impl GetAppsLocation200Response {
    pub fn new() -> GetAppsLocation200Response {
        GetAppsLocation200Response {
            status: None,
            data: None,
        }
    }
