...
pub struct ActiveLoginPhrases200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ActiveLoginPhrases200ResponseDataInner>>,
}

impl ActiveLoginPhrases200Response {
    pub fn new() -> ActiveLoginPhrases200Response {
        ActiveLoginPhrases200Response {
            status: None,
            data: None,
        }
    }
