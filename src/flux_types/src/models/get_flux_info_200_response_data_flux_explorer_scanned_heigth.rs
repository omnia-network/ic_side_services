...
pub struct GetFluxInfo200ResponseDataFluxExplorerScannedHeigth {
    /// Explorer block height
    #[serde(rename = "generalScannedHeight", skip_serializing_if = "Option::is_none")]
    pub general_scanned_height: Option<i32>,
}

impl GetFluxInfo200ResponseDataFluxExplorerScannedHeigth {
    pub fn new() -> GetFluxInfo200ResponseDataFluxExplorerScannedHeigth {
        GetFluxInfo200ResponseDataFluxExplorerScannedHeigth {
            general_scanned_height: None,
        }
    }
}
