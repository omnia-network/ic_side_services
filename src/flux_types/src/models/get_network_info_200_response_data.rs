...
pub struct GetNetworkInfo200ResponseData {
    /// The server version
    #[serde(rename = "version", skip_serializing_if = "Option::is_none")]
    pub version: Option<i32>,
    /// The server subversion string
    #[serde(rename = "subversion", skip_serializing_if = "Option::is_none")]
    pub subversion: Option<String>,
    /// The protocol version
    #[serde(rename = "protocolversion", skip_serializing_if = "Option::is_none")]
    pub protocolversion: Option<i32>,
    /// The services we offer to the network
    #[serde(rename = "localservices", skip_serializing_if = "Option::is_none")]
    ...
    pub networks: Option<Vec<crate::models::GetNetworkInfo200ResponseDataNetworksInner>>,
    ...
    pub localaddresses: Option<Vec<crate::models::GetNetworkInfo200ResponseDataLocaladdressesInner>>,
    /// Any network warnings (such as alert messages)
    #[serde(rename = "warnings", skip_serializing_if = "Option::is_none")]
    pub warnings: Option<String>,
}

impl GetNetworkInfo200ResponseData {
    pub fn new() -> GetNetworkInfo200ResponseData {
        GetNetworkInfo200ResponseData {
            version: None,
            subversion: None,
