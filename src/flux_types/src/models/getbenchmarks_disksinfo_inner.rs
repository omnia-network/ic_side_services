...
/// GetbenchmarksDisksinfoInner : Disks information



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetbenchmarksDisksinfoInner {
    /// Disk name
    #[serde(rename = "disk", skip_serializing_if = "Option::is_none")]
    pub disk: Option<String>,
    /// The amount of space detected
    #[serde(rename = "size", skip_serializing_if = "Option::is_none")]
    pub size: Option<f32>,
    /// The amount of write speed detected
    #[serde(rename = "writespeed", skip_serializing_if = "Option::is_none")]
    pub writespeed: Option<f32>,
}

impl GetbenchmarksDisksinfoInner {
    /// Disks information
    pub fn new() -> GetbenchmarksDisksinfoInner {
        GetbenchmarksDisksinfoInner {
            disk: None,
            size: None,
            writespeed: None,
        }
