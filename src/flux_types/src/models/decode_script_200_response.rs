...
pub struct DecodeScript200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Decodescript>>,
}

impl DecodeScript200Response {
    pub fn new() -> DecodeScript200Response {
        DecodeScript200Response {
            status: None,
            data: None,
        }
    }
