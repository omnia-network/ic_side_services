...
pub struct ListBanned200ResponseDataInner {
    /// Ip/subnet
    ...
    pub banned_until: Option<i32>,
}

impl ListBanned200ResponseDataInner {
    pub fn new() -> ListBanned200ResponseDataInner {
        ListBanned200ResponseDataInner {
            address: None,
            banned_until: None,
        }
    }
