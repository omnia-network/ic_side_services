...
pub struct AppInspect200ResponseDataGraphDriverData {
    #[serde(rename = "LowerDir", skip_serializing_if = "Option::is_none")]
    pub lower_dir: Option<String>,
    #[serde(rename = "MergedDir", skip_serializing_if = "Option::is_none")]
    pub merged_dir: Option<String>,
    #[serde(rename = "UpperDir", skip_serializing_if = "Option::is_none")]
    pub upper_dir: Option<String>,
    #[serde(rename = "WorkDir", skip_serializing_if = "Option::is_none")]
    pub work_dir: Option<String>,
}

impl AppInspect200ResponseDataGraphDriverData {
    pub fn new() -> AppInspect200ResponseDataGraphDriverData {
        AppInspect200ResponseDataGraphDriverData {
            lower_dir: None,
            merged_dir: None,
            upper_dir: None,
            work_dir: None,
