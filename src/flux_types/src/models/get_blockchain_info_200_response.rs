...
pub struct GetBlockchainInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetBlockchainInfo200ResponseData>>,
}

impl GetBlockchainInfo200Response {
    pub fn new() -> GetBlockchainInfo200Response {
        GetBlockchainInfo200Response {
            status: None,
            data: None,
        }
    }
