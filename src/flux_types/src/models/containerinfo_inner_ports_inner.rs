...
pub struct ContainerinfoInnerPortsInner {
    ...
    pub host_config: Option<Box<crate::models::ContainerinfoInnerPortsInnerHostConfig>>,
    #[serde(rename = "NetworkSettings", skip_serializing_if = "Option::is_none")]
    pub network_settings: Option<Box<crate::models::ContainerinfoInnerPortsInnerNetworkSettings>>,
    #[serde(rename = "Mounts", skip_serializing_if = "Option::is_none")]
    pub mounts: Option<Vec<crate::models::MountsInner>>,
}

impl ContainerinfoInnerPortsInner {
    pub fn new() -> ContainerinfoInnerPortsInner {
        ContainerinfoInnerPortsInner {
            private_port: None,
            r#type: None,
            ip: None,
            public_port: None,
