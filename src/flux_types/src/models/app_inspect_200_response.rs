...
pub struct AppInspect200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::AppInspect200ResponseData>>,
}

impl AppInspect200Response {
    pub fn new() -> AppInspect200Response {
        AppInspect200Response {
            status: None,
            data: None,
        }
    }
