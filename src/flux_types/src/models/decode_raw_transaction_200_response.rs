...
pub struct DecodeRawTransaction200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Decoderawtransaction>>,
}

impl DecodeRawTransaction200Response {
    pub fn new() -> DecodeRawTransaction200Response {
        DecodeRawTransaction200Response {
            status: None,
            data: None,
        }
    }
