...
pub struct ZcBenchmark200ResponseDataInner {
    /// Running time of the sample.
    #[serde(rename = "runningtime", skip_serializing_if = "Option::is_none")]
    pub runningtime: Option<f32>,
}

impl ZcBenchmark200ResponseDataInner {
    pub fn new() -> ZcBenchmark200ResponseDataInner {
        ZcBenchmark200ResponseDataInner {
            runningtime: None,
        }
    }
}
