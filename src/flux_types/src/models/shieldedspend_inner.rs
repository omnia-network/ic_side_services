...
pub struct ShieldedspendInner {
    /// The cv note encryption
    ...
    /// The spend signature
    #[serde(rename = "spendAuthSig", skip_serializing_if = "Option::is_none")]
    pub spend_auth_sig: Option<String>,
}

impl ShieldedspendInner {
    pub fn new() -> ShieldedspendInner {
        ShieldedspendInner {
            cv: None,
            anchor: None,
            nullifier: None,
