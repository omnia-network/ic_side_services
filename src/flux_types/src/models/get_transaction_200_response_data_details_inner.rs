...
impl GetTransaction200ResponseDataDetailsInner {
    pub fn new() -> GetTransaction200ResponseDataDetailsInner {
        GetTransaction200ResponseDataDetailsInner {
            account: None,
            address: None,
            category: None,
            amount: None,
