...
pub struct GetFluxGeolocation200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Geolocation>>,
}

impl GetFluxGeolocation200Response {
    pub fn new() -> GetFluxGeolocation200Response {
        GetFluxGeolocation200Response {
            status: None,
            data: None,
        }
    }
