...
pub struct GetAddressTransactions200ResponseData {
    /// Flux address
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
    #[serde(rename = "transactions", skip_serializing_if = "Option::is_none")]
    pub transactions: Option<Vec<crate::models::GetAddressTransactions200ResponseDataTransactionsInner>>,
}

impl GetAddressTransactions200ResponseData {
    pub fn new() -> GetAddressTransactions200ResponseData {
        GetAddressTransactions200ResponseData {
            address: None,
            transactions: None,
        }
    }
