...
pub struct PrioritiseTransaction200Response {
...
impl PrioritiseTransaction200Response {
    pub fn new() -> PrioritiseTransaction200Response {
        PrioritiseTransaction200Response {
            status: None,
            data: None,
        }
    }
