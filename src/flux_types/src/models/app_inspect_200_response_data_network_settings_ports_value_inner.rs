...
pub struct AppInspect200ResponseDataNetworkSettingsPortsValueInner {
...
impl AppInspect200ResponseDataNetworkSettingsPortsValueInner {
    pub fn new() -> AppInspect200ResponseDataNetworkSettingsPortsValueInner {
        AppInspect200ResponseDataNetworkSettingsPortsValueInner {
            host_ip: None,
            host_port: None,
        }
    }
