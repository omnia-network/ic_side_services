...
pub struct ZListReceivedByAddress200ResponseDataInner {
    /// Transaction id
...
impl ZListReceivedByAddress200ResponseDataInner {
    pub fn new() -> ZListReceivedByAddress200ResponseDataInner {
        ZListReceivedByAddress200ResponseDataInner {
            txid: None,
            jsindex: None,
            jsoutindex: None,
            amount: None,
