...
pub struct GetScannedHeight200ResponseData {
    /// Block height
    #[serde(rename = "generalScannedHeight", skip_serializing_if = "Option::is_none")]
    pub general_scanned_height: Option<i32>,
}

impl GetScannedHeight200ResponseData {
    pub fn new() -> GetScannedHeight200ResponseData {
        GetScannedHeight200ResponseData {
