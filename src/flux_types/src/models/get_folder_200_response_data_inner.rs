...
pub struct GetFolder200ResponseDataInner {
    /// Name of file
    ...
    /// True if item is symbolic link
    #[serde(rename = "isSymbolicLink", skip_serializing_if = "Option::is_none")]
    ...
    /// Share token when file is share
    #[serde(rename = "shareToken", skip_serializing_if = "Option::is_none")]
    pub share_token: Option<String>,
    /// Path if file is shared
    #[serde(rename = "shareFile", skip_serializing_if = "Option::is_none")]
    pub share_file: Option<String>,
}

impl GetFolder200ResponseDataInner {
    pub fn new() -> GetFolder200ResponseDataInner {
        GetFolder200ResponseDataInner {
            name: None,
            size: None,
            is_directory: None,
            is_file: None,
