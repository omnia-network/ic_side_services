...
pub struct AppChanges200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::AppChanges200ResponseDataInner>>,
}

impl AppChanges200Response {
    pub fn new() -> AppChanges200Response {
        AppChanges200Response {
            status: None,
            data: None,
        }
    }
