...
pub struct ConnectedPeersInfo200ResponseDataInner {
    /// Ip address of connected peer
    #[serde(rename = "ip", skip_serializing_if = "Option::is_none")]
    pub ip: Option<String>,
    /// Round trip time of packets being sent back and forth between peers
    #[serde(rename = "rtt", skip_serializing_if = "Option::is_none")]
    pub rtt: Option<i32>,
}

impl ConnectedPeersInfo200ResponseDataInner {
    pub fn new() -> ConnectedPeersInfo200ResponseDataInner {
        ConnectedPeersInfo200ResponseDataInner {
            ip: None,
            rtt: None,
        }
    }
