...
pub struct BroadcastMessageFromUserPostRequest {
    /// The message
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<String>,
}

impl BroadcastMessageFromUserPostRequest {
    pub fn new() -> BroadcastMessageFromUserPostRequest {
        BroadcastMessageFromUserPostRequest {
            data: None,
        }
    }
}
