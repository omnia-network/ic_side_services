...
pub struct CreateRawTransactionTransactionsParameterOneOfInner {
    /// Txid to use to get the raw data
    #[serde(rename = "txid", skip_serializing_if = "Option::is_none")]
    pub txid: Option<String>,
    /// The output number
    #[serde(rename = "vout", skip_serializing_if = "Option::is_none")]
    pub vout: Option<i32>,
    /// The sequence number (optional)
    #[serde(rename = "sequence", skip_serializing_if = "Option::is_none")]
    pub sequence: Option<i32>,
}

impl CreateRawTransactionTransactionsParameterOneOfInner {
    pub fn new() -> CreateRawTransactionTransactionsParameterOneOfInner {
        CreateRawTransactionTransactionsParameterOneOfInner {
            txid: None,
            vout: None,
            sequence: None,
        }
