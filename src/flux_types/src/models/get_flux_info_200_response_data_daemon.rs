...
pub struct GetFluxInfo200ResponseDataDaemon {
    #[serde(rename = "info", skip_serializing_if = "Option::is_none")]
    pub info: Option<Box<crate::models::Daemongetinfo>>,
}

impl GetFluxInfo200ResponseDataDaemon {
    pub fn new() -> GetFluxInfo200ResponseDataDaemon {
        GetFluxInfo200ResponseDataDaemon {
            info: None,
        }
    }
}
