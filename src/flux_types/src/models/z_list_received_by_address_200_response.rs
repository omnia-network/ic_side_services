...
pub struct ZListReceivedByAddress200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ZListReceivedByAddress200ResponseDataInner>>,
}

impl ZListReceivedByAddress200Response {
    pub fn new() -> ZListReceivedByAddress200Response {
        ZListReceivedByAddress200Response {
            status: None,
            data: None,
        }
    }
