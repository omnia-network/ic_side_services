...
pub struct GetFluxKadena200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Kadena address and chain ID
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<String>,
}

impl GetFluxKadena200Response {
    pub fn new() -> GetFluxKadena200Response {
        GetFluxKadena200Response {
            status: None,
            data: None,
        }
    }
