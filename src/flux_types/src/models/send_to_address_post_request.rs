...
pub struct SendToAddressPostRequest {
    ...
    #[serde(rename = "commentto", skip_serializing_if = "Option::is_none")]
    pub commentto: Option<String>,
    /// Subtract the transaction fee equally from the output amounts. (optional)
    #[serde(rename = "substractfeefromamount", skip_serializing_if = "Option::is_none")]
    pub substractfeefromamount: Option<bool>,
}

impl SendToAddressPostRequest {
    pub fn new() -> SendToAddressPostRequest {
        SendToAddressPostRequest {
            fluxaddress: None,
            amount: None,
            comment: None,
            commentto: None,
            substractfeefromamount: None,
        }
    }
}
