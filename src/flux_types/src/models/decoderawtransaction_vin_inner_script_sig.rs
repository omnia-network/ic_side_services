...
pub struct DecoderawtransactionVinInnerScriptSig {
    /// Script public key
...
impl DecoderawtransactionVinInnerScriptSig {
    pub fn new() -> DecoderawtransactionVinInnerScriptSig {
        DecoderawtransactionVinInnerScriptSig {
            asm: None,
            hex: None,
        }
    }
