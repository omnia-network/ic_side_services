...
pub struct ListSinceBlock200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ListSinceBlock200ResponseData>>,
}

impl ListSinceBlock200Response {
    pub fn new() -> ListSinceBlock200Response {
        ListSinceBlock200Response {
            status: None,
            data: None,
        }
    }
