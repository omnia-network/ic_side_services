...
pub struct AppslocationInner {
    ...
    /// Start date and timestamp of app
    #[serde(rename = "broadcastedAt", skip_serializing_if = "Option::is_none")]
    pub broadcasted_at: Option<String>,
    /// Expiration date and timestamp of app
...
impl AppslocationInner {
    pub fn new() -> AppslocationInner {
        AppslocationInner {
            ip: None,
            name: None,
            broadcasted_at: None,
