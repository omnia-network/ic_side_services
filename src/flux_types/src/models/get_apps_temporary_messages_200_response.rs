...
pub struct GetAppsTemporaryMessages200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetAppsTemporaryMessages200ResponseDataInner>>,
}

impl GetAppsTemporaryMessages200Response {
    pub fn new() -> GetAppsTemporaryMessages200Response {
        GetAppsTemporaryMessages200Response {
            status: None,
            data: None,
        }
    }
