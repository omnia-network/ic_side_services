...
impl FluxNodeCurrentWinner200ResponseDataCumulusWinner {
    pub fn new() -> FluxNodeCurrentWinner200ResponseDataCumulusWinner {
        FluxNodeCurrentWinner200ResponseDataCumulusWinner {
            collateral: None,
            ip: None,
            added_height: None,
