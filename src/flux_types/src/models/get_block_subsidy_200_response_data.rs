...
pub struct GetBlockSubsidy200ResponseData {
    /// The mining reward amount in FLUX
    #[serde(rename = "miner", skip_serializing_if = "Option::is_none")]
    pub miner: Option<i32>,
}

impl GetBlockSubsidy200ResponseData {
    pub fn new() -> GetBlockSubsidy200ResponseData {
        GetBlockSubsidy200ResponseData {
            miner: None,
        }
    }
}
