...
pub struct ListFluxNodeConf200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ListFluxNodeConf200ResponseDataInner>>,
}

impl ListFluxNodeConf200Response {
    pub fn new() -> ListFluxNodeConf200Response {
        ListFluxNodeConf200Response {
            status: None,
            data: None,
        }
    }
