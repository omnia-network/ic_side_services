...
pub struct GetBlockTemplate200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetBlockTemplate200ResponseData>>,
}

impl GetBlockTemplate200Response {
    pub fn new() -> GetBlockTemplate200Response {
        GetBlockTemplate200Response {
            status: None,
            data: None,
        }
    }
