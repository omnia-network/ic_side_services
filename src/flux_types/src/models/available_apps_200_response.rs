...
pub struct AvailableApps200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::AvailableApps200ResponseDataInner>>,
}

impl AvailableApps200Response {
    pub fn new() -> AvailableApps200Response {
        AvailableApps200Response {
            status: None,
            data: None,
        }
    }
