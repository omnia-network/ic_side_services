...
pub struct DecoderawtransactionVinInner {
    /// The transaction id
    ...
    pub script_sig: Option<Box<crate::models::DecoderawtransactionVinInnerScriptSig>>,
    /// The script sequence number
    #[serde(rename = "sequence", skip_serializing_if = "Option::is_none")]
    pub sequence: Option<i32>,
}

impl DecoderawtransactionVinInner {
    pub fn new() -> DecoderawtransactionVinInner {
        DecoderawtransactionVinInner {
            txid: None,
            vout: None,
            script_sig: None,
            sequence: None,
