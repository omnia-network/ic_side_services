...
pub struct IncomingConnectionsInfo200ResponseDataInner {
    /// Ip address of incoming connection
    #[serde(rename = "ip", skip_serializing_if = "Option::is_none")]
    pub ip: Option<String>,
    /// Round trip time of packets being sent back and forth for incoming connection
    #[serde(rename = "rtt", skip_serializing_if = "Option::is_none")]
    pub rtt: Option<String>,
}

impl IncomingConnectionsInfo200ResponseDataInner {
    pub fn new() -> IncomingConnectionsInfo200ResponseDataInner {
        IncomingConnectionsInfo200ResponseDataInner {
            ip: None,
            rtt: None,
        }
    }
