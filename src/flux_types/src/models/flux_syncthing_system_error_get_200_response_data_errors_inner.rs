...
pub struct FluxSyncthingSystemErrorGet200ResponseDataErrorsInner {
...
impl FluxSyncthingSystemErrorGet200ResponseDataErrorsInner {
    pub fn new() -> FluxSyncthingSystemErrorGet200ResponseDataErrorsInner {
        FluxSyncthingSystemErrorGet200ResponseDataErrorsInner {
            when: None,
            message: None,
            level: None,
        }
