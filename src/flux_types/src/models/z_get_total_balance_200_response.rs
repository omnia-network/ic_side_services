...
pub struct ZGetTotalBalance200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ZGetTotalBalance200ResponseData>>,
}

impl ZGetTotalBalance200Response {
    pub fn new() -> ZGetTotalBalance200Response {
        ZGetTotalBalance200Response {
            status: None,
            data: None,
        }
    }
