...
pub struct LockUnspentTransactionsParameterInner {
    /// transaction id
...
impl LockUnspentTransactionsParameterInner {
    pub fn new() -> LockUnspentTransactionsParameterInner {
        LockUnspentTransactionsParameterInner {
            txid: None,
            vout: None,
        }
    }
