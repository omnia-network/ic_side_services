...
pub struct GetChainTips200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetChainTips200ResponseDataInner>>,
}

impl GetChainTips200Response {
    pub fn new() -> GetChainTips200Response {
        GetChainTips200Response {
            status: None,
            data: None,
        }
    }
