...
pub struct ZcBenchmark200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ZcBenchmark200ResponseDataInner>>,
}

impl ZcBenchmark200Response {
    pub fn new() -> ZcBenchmark200Response {
        ZcBenchmark200Response {
            status: None,
            data: None,
        }
    }
