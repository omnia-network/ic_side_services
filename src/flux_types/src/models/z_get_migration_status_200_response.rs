...
pub struct ZGetMigrationStatus200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ZGetMigrationStatus200ResponseData>>,
}

impl ZGetMigrationStatus200Response {
    pub fn new() -> ZGetMigrationStatus200Response {
        ZGetMigrationStatus200Response {
            status: None,
            data: None,
        }
    }
