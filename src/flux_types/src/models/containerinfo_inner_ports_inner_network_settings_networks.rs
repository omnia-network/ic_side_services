...
/// ContainerinfoInnerPortsInnerNetworkSettingsNetworks : Configuration for a network endpoint.



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContainerinfoInnerPortsInnerNetworkSettingsNetworks {
...
impl ContainerinfoInnerPortsInnerNetworkSettingsNetworks {
    /// Configuration for a network endpoint.
    pub fn new() -> ContainerinfoInnerPortsInnerNetworkSettingsNetworks {
        ContainerinfoInnerPortsInnerNetworkSettingsNetworks {
