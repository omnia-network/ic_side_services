...
pub struct GetBenchStatus200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Benchstatus>>,
}

impl GetBenchStatus200Response {
    pub fn new() -> GetBenchStatus200Response {
        GetBenchStatus200Response {
            status: None,
            data: None,
        }
    }
