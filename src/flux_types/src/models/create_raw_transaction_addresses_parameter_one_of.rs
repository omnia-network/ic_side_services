...
pub struct CreateRawTransactionAddressesParameterOneOf {
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
}

impl CreateRawTransactionAddressesParameterOneOf {
    pub fn new() -> CreateRawTransactionAddressesParameterOneOf {
        CreateRawTransactionAddressesParameterOneOf {
            address: None,
        }
    }
}
