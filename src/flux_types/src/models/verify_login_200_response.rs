...
pub struct VerifyLogin200Response {
    /// status
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::VerifyLogin200ResponseData>>,
}

impl VerifyLogin200Response {
    pub fn new() -> VerifyLogin200Response {
        VerifyLogin200Response {
            status: None,
            data: None,
        }
    }
