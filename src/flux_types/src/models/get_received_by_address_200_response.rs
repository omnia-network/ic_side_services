...
pub struct GetReceivedByAddress200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// The total amount in FLUX received at this address
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<f32>,
}

impl GetReceivedByAddress200Response {
    pub fn new() -> GetReceivedByAddress200Response {
        GetReceivedByAddress200Response {
            status: None,
            data: None,
        }
    }
