...
pub struct FluxSyncthingSystemRestart200ResponseData {
    #[serde(rename = "ok", skip_serializing_if = "Option::is_none")]
    pub ok: Option<String>,
}

impl FluxSyncthingSystemRestart200ResponseData {
    pub fn new() -> FluxSyncthingSystemRestart200ResponseData {
        FluxSyncthingSystemRestart200ResponseData {
            ok: None,
        }
    }
}
