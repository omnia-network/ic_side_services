...
pub struct CreateRawTransaction200Response {
...
impl CreateRawTransaction200Response {
    pub fn new() -> CreateRawTransaction200Response {
        CreateRawTransaction200Response {
            status: None,
            data: None,
        }
    }
