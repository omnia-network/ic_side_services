...
/// CreateRawTransactionPostRequestTransactionsInner : Objects pertaining to the transaction



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateRawTransactionPostRequestTransactionsInner {
    /// The transaction id
...
impl CreateRawTransactionPostRequestTransactionsInner {
    /// Objects pertaining to the transaction
    pub fn new() -> CreateRawTransactionPostRequestTransactionsInner {
        CreateRawTransactionPostRequestTransactionsInner {
            txid: None,
            vout: None,
            sequence: None,
        }
