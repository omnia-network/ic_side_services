...
pub struct GetTxOut200ResponseData {
    /// Block hash
    ...
    /// The transaction value in FLUX
    #[serde(rename = "value", skip_serializing_if = "Option::is_none")]
    pub value: Option<f32>,
    #[serde(rename = "scriptPubKey", skip_serializing_if = "Option::is_none")]
    pub script_pub_key: Option<Box<crate::models::GetTxOut200ResponseDataScriptPubKey>>,
    /// The version number
...
impl GetTxOut200ResponseData {
    pub fn new() -> GetTxOut200ResponseData {
        GetTxOut200ResponseData {
            bestblock: None,
            confirmations: None,
            value: None,
            script_pub_key: None,
