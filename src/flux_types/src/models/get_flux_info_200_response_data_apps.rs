...
pub struct GetFluxInfo200ResponseDataApps {
    /// Amount of CPU usage
    #[serde(rename = "fluxusage", skip_serializing_if = "Option::is_none")]
    pub fluxusage: Option<String>,
    #[serde(rename = "runningapps", skip_serializing_if = "Option::is_none")]
    pub runningapps: Option<Vec<crate::models::ContainerinfoInner>>,
    #[serde(rename = "resources", skip_serializing_if = "Option::is_none")]
    pub resources: Option<Box<crate::models::Appsresources>>,
}

impl GetFluxInfo200ResponseDataApps {
    pub fn new() -> GetFluxInfo200ResponseDataApps {
        GetFluxInfo200ResponseDataApps {
            fluxusage: None,
            runningapps: None,
            resources: None,
        }
