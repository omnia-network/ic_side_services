...
pub struct StreamdataProgressDetail {
    /// Progress in bytes
    #[serde(rename = "current", skip_serializing_if = "Option::is_none")]
    pub current: Option<i32>,
    /// Total byte size of download
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<i32>,
}

impl StreamdataProgressDetail {
    pub fn new() -> StreamdataProgressDetail {
        StreamdataProgressDetail {
            current: None,
            total: None,
        }
    }
