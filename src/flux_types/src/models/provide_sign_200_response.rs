...
pub struct ProvideSign200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::ProvideSign200ResponseData>>,
}

impl ProvideSign200Response {
    pub fn new() -> ProvideSign200Response {
        ProvideSign200Response {
            status: None,
            data: None,
        }
    }
