...
pub struct CreateRawTransactionAddressesParameter {
    #[serde(rename = "address", skip_serializing_if = "Option::is_none")]
    pub address: Option<String>,
}

impl CreateRawTransactionAddressesParameter {
    pub fn new() -> CreateRawTransactionAddressesParameter {
        CreateRawTransactionAddressesParameter {
            address: None,
        }
    }
}
