...
pub struct ZValidateAddress200ResponseData {
    ...
    /// The hex value of the diversifier, d
    #[serde(rename = "diversifier", skip_serializing_if = "Option::is_none")]
    pub diversifier: Option<String>,
    /// The hex value of pk_d
...
impl ZValidateAddress200ResponseData {
    pub fn new() -> ZValidateAddress200ResponseData {
        ZValidateAddress200ResponseData {
            isvalid: None,
            address: None,
            r#type: None,
            diversifier: None,
            diversifiedtransmissionkey: None,
            ismine: None,
        }
    }
}
