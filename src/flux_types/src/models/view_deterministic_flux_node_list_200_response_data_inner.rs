...
pub struct ViewDeterministicFluxNodeList200ResponseDataInner {
    ...
    /// Active time of FluxNode in epoch
...
impl ViewDeterministicFluxNodeList200ResponseDataInner {
    pub fn new() -> ViewDeterministicFluxNodeList200ResponseDataInner {
        ViewDeterministicFluxNodeList200ResponseDataInner {
            collateral: None,
            txhash: None,
            outidx: None,
            ip: None,
