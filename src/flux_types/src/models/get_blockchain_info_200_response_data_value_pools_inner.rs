...
pub struct GetBlockchainInfo200ResponseDataValuePoolsInner {
    /// Name of pool
...
impl GetBlockchainInfo200ResponseDataValuePoolsInner {
    pub fn new() -> GetBlockchainInfo200ResponseDataValuePoolsInner {
        GetBlockchainInfo200ResponseDataValuePoolsInner {
            id: None,
            monitored: None,
            chain_value: None,
