...
pub struct FluxSyncthingSysytemBrowse200Response {
...
impl FluxSyncthingSysytemBrowse200Response {
    pub fn new() -> FluxSyncthingSysytemBrowse200Response {
        FluxSyncthingSysytemBrowse200Response {
            status: None,
            data: None,
        }
    }
