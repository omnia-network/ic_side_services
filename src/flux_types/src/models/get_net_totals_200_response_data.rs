...
pub struct GetNetTotals200ResponseData {
    /// Total bytes received
    #[serde(rename = "totalbytesrecv", skip_serializing_if = "Option::is_none")]
    pub totalbytesrecv: Option<i32>,
    /// Total bytes sent
    #[serde(rename = "totalbytessent", skip_serializing_if = "Option::is_none")]
    pub totalbytessent: Option<i32>,
    /// Total cpu time
    #[serde(rename = "timemillis", skip_serializing_if = "Option::is_none")]
    pub timemillis: Option<i32>,
}

impl GetNetTotals200ResponseData {
    pub fn new() -> GetNetTotals200ResponseData {
        GetNetTotals200ResponseData {
            totalbytesrecv: None,
            totalbytessent: None,
            timemillis: None,
        }
