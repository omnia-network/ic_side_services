...
pub struct GetAddressUtxos200ResponseDataInner {
    /// The transaction id
    #[serde(rename = "txid", skip_serializing_if = "Option::is_none")]
    pub txid: Option<String>,
    /// Vout index of the transaction
    #[serde(rename = "voutIndex", skip_serializing_if = "Option::is_none")]
    ...
    /// Value of Flux in satoshi
    #[serde(rename = "satoshis", skip_serializing_if = "Option::is_none")]
    pub satoshis: Option<i32>,
    /// Script public key
...
impl GetAddressUtxos200ResponseDataInner {
    pub fn new() -> GetAddressUtxos200ResponseDataInner {
        GetAddressUtxos200ResponseDataInner {
            txid: None,
            vout_index: None,
            height: None,
            address: None,
