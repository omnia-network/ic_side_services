...
pub struct EstimateFee200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Estimated fee-per-kilobyte -1.0 is returned if not enough transactions and blocks have been observed to make an estimate.
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<i32>,
}

impl EstimateFee200Response {
    pub fn new() -> EstimateFee200Response {
