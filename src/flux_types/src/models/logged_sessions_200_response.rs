...
pub struct LoggedSessions200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::LoggedSessions200ResponseDataInner>>,
}

impl LoggedSessions200Response {
    pub fn new() -> LoggedSessions200Response {
        LoggedSessions200Response {
            status: None,
            data: None,
        }
    }
