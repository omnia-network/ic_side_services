...
pub struct Stats200ResponseData {
    /// Available space in fluxshare
    #[serde(rename = "available", skip_serializing_if = "Option::is_none")]
    pub available: Option<f32>,
    /// Used space in fluxshare
    #[serde(rename = "used", skip_serializing_if = "Option::is_none")]
    pub used: Option<f32>,
    /// Total space in fluxshare
    #[serde(rename = "total", skip_serializing_if = "Option::is_none")]
    pub total: Option<f32>,
}

impl Stats200ResponseData {
    pub fn new() -> Stats200ResponseData {
        Stats200ResponseData {
            available: None,
            used: None,
            total: None,
        }
