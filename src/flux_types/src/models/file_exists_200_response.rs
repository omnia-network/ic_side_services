...
pub struct FileExists200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::FileExists200ResponseData>>,
}

impl FileExists200Response {
    pub fn new() -> FileExists200Response {
        FileExists200Response {
            status: None,
            data: None,
        }
    }
