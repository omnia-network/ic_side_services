...
pub struct VerifyLogin200ResponseData {
    /// explanation of status
    #[serde(rename = "message", skip_serializing_if = "Option::is_none")]
    pub message: Option<String>,
    /// supplied ZelID or bitcoin P2PKH address or ethereum address
    #[serde(rename = "zelid", skip_serializing_if = "Option::is_none")]
    pub zelid: Option<String>,
    /// valid and active loginPhrase
    #[serde(rename = "loginPhrase", skip_serializing_if = "Option::is_none")]
    pub login_phrase: Option<String>,
    /// signature of loginPhrase signed with zelid/btc/eth address
    #[serde(rename = "signature", skip_serializing_if = "Option::is_none")]
    pub signature: Option<String>,
    /// granted Flux privilege
    #[serde(rename = "privilege", skip_serializing_if = "Option::is_none")]
    pub privilege: Option<Privilege>,
}

impl VerifyLogin200ResponseData {
    pub fn new() -> VerifyLogin200ResponseData {
        VerifyLogin200ResponseData {
            message: None,
            zelid: None,
            login_phrase: None,
            signature: None,
