...
pub struct GetFluxStaticIp200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// static ip ISP/Org or not
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<bool>,
}

impl GetFluxStaticIp200Response {
    pub fn new() -> GetFluxStaticIp200Response {
        GetFluxStaticIp200Response {
            status: None,
            data: None,
        }
    }
