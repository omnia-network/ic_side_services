...
pub struct ListSinceBlock200ResponseData {
    #[serde(rename = "transactions", skip_serializing_if = "Option::is_none")]
    pub transactions: Option<Vec<crate::models::ListtransactionsInner>>,
    /// The hash of the last block
    #[serde(rename = "lastblock", skip_serializing_if = "Option::is_none")]
    pub lastblock: Option<String>,
}

impl ListSinceBlock200ResponseData {
    pub fn new() -> ListSinceBlock200ResponseData {
        ListSinceBlock200ResponseData {
            transactions: None,
            lastblock: None,
        }
    }
