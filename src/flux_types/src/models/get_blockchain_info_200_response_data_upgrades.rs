...
pub struct GetBlockchainInfo200ResponseDataUpgrades {
    #[serde(rename = "76b809bb", skip_serializing_if = "Option::is_none")]
    pub param_76b809bb: Option<Box<crate::models::GetBlockchainInfo200ResponseDataUpgrades76b809bb>>,
}

impl GetBlockchainInfo200ResponseDataUpgrades {
    pub fn new() -> GetBlockchainInfo200ResponseDataUpgrades {
        GetBlockchainInfo200ResponseDataUpgrades {
            param_76b809bb: None,
        }
    }
}
