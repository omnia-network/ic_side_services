...
pub struct StartFluxNode200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Startfluxnode>>,
}

impl StartFluxNode200Response {
    pub fn new() -> StartFluxNode200Response {
        StartFluxNode200Response {
            status: None,
            data: None,
        }
    }
