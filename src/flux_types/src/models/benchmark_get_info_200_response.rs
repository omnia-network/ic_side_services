...
pub struct BenchmarkGetInfo200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Benchinfo>>,
}

impl BenchmarkGetInfo200Response {
    pub fn new() -> BenchmarkGetInfo200Response {
        BenchmarkGetInfo200Response {
            status: None,
            data: None,
        }
    }
