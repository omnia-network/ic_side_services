...
/// ContainerinfoInnerPortsInnerNetworkSettings : A summary of the container's network settings



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ContainerinfoInnerPortsInnerNetworkSettings {
    #[serde(rename = "Networks", skip_serializing_if = "Option::is_none")]
    pub networks: Option<Box<crate::models::ContainerinfoInnerPortsInnerNetworkSettingsNetworks>>,
}

impl ContainerinfoInnerPortsInnerNetworkSettings {
    /// A summary of the container's network settings
    pub fn new() -> ContainerinfoInnerPortsInnerNetworkSettings {
        ContainerinfoInnerPortsInnerNetworkSettings {
            networks: None,
        }
    }
}
