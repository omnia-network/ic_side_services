...
pub struct GetBlockTemplateJsonrequestobjectParameter {
...
impl GetBlockTemplateJsonrequestobjectParameter {
    pub fn new() -> GetBlockTemplateJsonrequestobjectParameter {
        GetBlockTemplateJsonrequestobjectParameter {
            mode: None,
            capabilities: None,
        }
    }
