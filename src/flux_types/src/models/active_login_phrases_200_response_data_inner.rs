...
pub struct ActiveLoginPhrases200ResponseDataInner {
    /// active login phrase
    #[serde(rename = "loginPhrase", skip_serializing_if = "Option::is_none")]
    pub login_phrase: Option<String>,
    /// timestamp of loginPhrase creation in server time.
    #[serde(rename = "createdAt", skip_serializing_if = "Option::is_none")]
    pub created_at: Option<String>,
    /// expiration timestamp of loginPhrase. After this time, the loginPhrase cannot be used anymore.
    #[serde(rename = "expireAt", skip_serializing_if = "Option::is_none")]
    pub expire_at: Option<String>,
}

impl ActiveLoginPhrases200ResponseDataInner {
    pub fn new() -> ActiveLoginPhrases200ResponseDataInner {
        ActiveLoginPhrases200ResponseDataInner {
            login_phrase: None,
            created_at: None,
            expire_at: None,
        }
