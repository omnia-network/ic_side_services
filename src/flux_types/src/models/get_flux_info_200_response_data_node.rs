...
pub struct GetFluxInfo200ResponseDataNode {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::Fluxnodestatus>>,
}

impl GetFluxInfo200ResponseDataNode {
    pub fn new() -> GetFluxInfo200ResponseDataNode {
        GetFluxInfo200ResponseDataNode {
            status: None,
        }
    }
}
