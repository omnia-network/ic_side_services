...
pub struct SignRawTransactionPrevtxsParameterInner {
    /// The transaction id
...
impl SignRawTransactionPrevtxsParameterInner {
    pub fn new() -> SignRawTransactionPrevtxsParameterInner {
        SignRawTransactionPrevtxsParameterInner {
            txid: None,
            vout: None,
            script_pub_key: None,
            redeem_script: None,
