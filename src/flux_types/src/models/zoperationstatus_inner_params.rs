...
pub struct ZoperationstatusInnerParams {
    /// Address funds sent from
    #[serde(rename = "fromaddress", skip_serializing_if = "Option::is_none")]
    pub fromaddress: Option<String>,
    #[serde(rename = "amounts", skip_serializing_if = "Option::is_none")]
    pub amounts: Option<Vec<crate::models::ZoperationstatusInnerParamsAmountsInner>>,
}

impl ZoperationstatusInnerParams {
    pub fn new() -> ZoperationstatusInnerParams {
        ZoperationstatusInnerParams {
            fromaddress: None,
            amounts: None,
        }
    }
