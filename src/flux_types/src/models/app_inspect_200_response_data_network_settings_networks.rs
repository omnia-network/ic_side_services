...
/// AppInspect200ResponseDataNetworkSettingsNetworks : Information about all networks that the container is connected to



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AppInspect200ResponseDataNetworkSettingsNetworks {
    #[serde(rename = "fluxDockerNetwork", skip_serializing_if = "Option::is_none")]
    pub flux_docker_network: Option<Box<crate::models::Fluxnetwork>>,
}

impl AppInspect200ResponseDataNetworkSettingsNetworks {
    /// Information about all networks that the container is connected to
    pub fn new() -> AppInspect200ResponseDataNetworkSettingsNetworks {
        AppInspect200ResponseDataNetworkSettingsNetworks {
            flux_docker_network: None,
        }
    }
}
