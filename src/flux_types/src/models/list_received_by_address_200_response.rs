...
pub struct ListReceivedByAddress200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::ListReceivedByAddress200ResponseDataInner>>,
}

impl ListReceivedByAddress200Response {
    pub fn new() -> ListReceivedByAddress200Response {
        ListReceivedByAddress200Response {
            status: None,
            data: None,
        }
    }
