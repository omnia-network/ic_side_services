...
pub struct GetFolder200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<crate::models::GetFolder200ResponseDataInner>>,
}

impl GetFolder200Response {
    pub fn new() -> GetFolder200Response {
        GetFolder200Response {
            status: None,
            data: None,
        }
    }
