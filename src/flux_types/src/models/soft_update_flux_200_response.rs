...
pub struct SoftUpdateFlux200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Perform a soft update of Flux
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<String>,
}

impl SoftUpdateFlux200Response {
    pub fn new() -> SoftUpdateFlux200Response {
        SoftUpdateFlux200Response {
            status: None,
            data: None,
        }
    }
