...
/// ListAppsImages200ResponseDataInnerLabels : User-defined key/value metadata



#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ListAppsImages200ResponseDataInnerLabels {
...
impl ListAppsImages200ResponseDataInnerLabels {
    /// User-defined key/value metadata
    pub fn new() -> ListAppsImages200ResponseDataInnerLabels {
        ListAppsImages200ResponseDataInnerLabels {
            description: None,
            maintainer: None,
            repository: None,
            version: None,
