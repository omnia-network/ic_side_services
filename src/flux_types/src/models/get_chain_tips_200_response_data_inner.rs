...
pub struct GetChainTips200ResponseDataInner {
    /// Height of chain tip
    ...
    /// Length of branch connecting the tip to the main chain (0 if main chain)
    #[serde(rename = "branchlen", skip_serializing_if = "Option::is_none")]
    pub branchlen: Option<i32>,
    /// Status of the chain
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<String>,
}

impl GetChainTips200ResponseDataInner {
    pub fn new() -> GetChainTips200ResponseDataInner {
        GetChainTips200ResponseDataInner {
            height: None,
            hash: None,
            branchlen: None,
            status: None,
