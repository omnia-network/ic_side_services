...
pub struct Fluxrestartbenchmark200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    /// Restart performance benchmark
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<String>,
}

impl Fluxrestartbenchmark200Response {
    pub fn new() -> Fluxrestartbenchmark200Response {
        Fluxrestartbenchmark200Response {
            status: None,
            data: None,
        }
    }
