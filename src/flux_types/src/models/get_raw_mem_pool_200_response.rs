...
pub struct GetRawMemPool200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::GetRawMemPool200ResponseData>>,
}

impl GetRawMemPool200Response {
    pub fn new() -> GetRawMemPool200Response {
        GetRawMemPool200Response {
            status: None,
            data: None,
        }
    }
