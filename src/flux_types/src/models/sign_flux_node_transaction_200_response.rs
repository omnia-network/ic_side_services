...
pub struct SignFluxNodeTransaction200Response {
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<crate::models::Status>,
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Box<crate::models::Signfluxnodetransaction>>,
}

impl SignFluxNodeTransaction200Response {
    pub fn new() -> SignFluxNodeTransaction200Response {
        SignFluxNodeTransaction200Response {
            status: None,
            data: None,
        }
    }
