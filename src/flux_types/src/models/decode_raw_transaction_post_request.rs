...
pub struct DecodeRawTransactionPostRequest {
    /// Hex-encoded transaction
    #[serde(rename = "hexstring", skip_serializing_if = "Option::is_none")]
    pub hexstring: Option<String>,
}

impl DecodeRawTransactionPostRequest {
    pub fn new() -> DecodeRawTransactionPostRequest {
        DecodeRawTransactionPostRequest {
            hexstring: None,
        }
    }
}
