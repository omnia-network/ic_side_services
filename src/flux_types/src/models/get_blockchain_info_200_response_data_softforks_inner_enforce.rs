...
pub struct GetBlockchainInfo200ResponseDataSoftforksInnerEnforce {
...
impl GetBlockchainInfo200ResponseDataSoftforksInnerEnforce {
    pub fn new() -> GetBlockchainInfo200ResponseDataSoftforksInnerEnforce {
        GetBlockchainInfo200ResponseDataSoftforksInnerEnforce {
            status: None,
            found: None,
            required: None,
            window: None,
