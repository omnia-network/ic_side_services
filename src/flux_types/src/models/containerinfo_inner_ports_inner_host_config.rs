...
pub struct ContainerinfoInnerPortsInnerHostConfig {
    /// Network mode of container
    #[serde(rename = "NetworkMode", skip_serializing_if = "Option::is_none")]
    pub network_mode: Option<String>,
}

impl ContainerinfoInnerPortsInnerHostConfig {
    pub fn new() -> ContainerinfoInnerPortsInnerHostConfig {
        ContainerinfoInnerPortsInnerHostConfig {
            network_mode: None,
        }
    }
}
