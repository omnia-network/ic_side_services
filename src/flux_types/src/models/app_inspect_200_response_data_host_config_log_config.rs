...
pub struct AppInspect200ResponseDataHostConfigLogConfig {
...
impl AppInspect200ResponseDataHostConfigLogConfig {
    pub fn new() -> AppInspect200ResponseDataHostConfigLogConfig {
        AppInspect200ResponseDataHostConfigLogConfig {
            r#type: None,
            config: None,
        }
    }
