...
pub struct GetFluxInfo200ResponseDataBenchmark {
    #[serde(rename = "info", skip_serializing_if = "Option::is_none")]
    pub info: Option<Box<crate::models::Benchinfo>>,
    #[serde(rename = "status", skip_serializing_if = "Option::is_none")]
    pub status: Option<Box<crate::models::Benchstatus>>,
    #[serde(rename = "bench", skip_serializing_if = "Option::is_none")]
    pub bench: Option<Box<crate::models::Getbenchmarks>>,
}

impl GetFluxInfo200ResponseDataBenchmark {
    pub fn new() -> GetFluxInfo200ResponseDataBenchmark {
        GetFluxInfo200ResponseDataBenchmark {
            info: None,
            status: None,
            bench: None,
        }
